...
<div class="card">
    <form action="{{ route('service.anc.update') }}" method="post" autocomplete="off">
        @csrf
                    ...
                    <div class="form-group">
                        <label for="sanc_kia">Apakah Ibu Hamil mempunyai buku KIA?</label>
                                <select name="sanc_kia" id="sanc_kia" class="form-control select2" style=" font-size: 14pt;">
                                    ...
                                    <option value="0" {{ (old('sanc_kia') == '0') ? 'selected' : (($ancx->sanc_kia == '0') ? 'selected' : '') }}>TIDAK PUNYA</option>
                                    <option value="1" {{ (old('sanc_kia') == '1') ? 'selected' : (($ancx->sanc_kia == '1') ? 'selected' : '') }}>PUNYA</option>
                                </select>
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-8">
                                <select name="sanc_gravida" id="sanc_gravida" class="form-control select2" style=" font-size: 14pt;">
                                    @for ($i = 1; $i < 16; $i++)
                                        <option value="{{ $i }}"  {{ (old('sanc_gravida') == $i) ? 'selected' : (($i == $ancx->sanc_gravida) ? 'selected' : '') }}>{{ $i }}</option>
                                    @endfor
                                </select>
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-8">
                                <select name="sanc_partus" id="sanc_partus" class="form-control select2" style=" font-size: 14pt;">
                                    @for ($i = 0; $i < 16; $i++)
                                        <option value="{{ $i }}"  {{ (old('sanc_partus') == $i) ? 'selected' : (($i == $ancx->sanc_partus) ? 'selected' : '') }}>{{ $i }}</option>
                                    @endfor
                                </select>
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-8">
                                <select name="sanc_aborsi" id="sanc_aborsi" class="form-control select2" style=" font-size: 14pt;">
                                    @for ($i = 0; $i < 16; $i++)
                                        <option value="{{ $i }}"  {{ (old('sanc_aborsi') == $i) ? 'selected' : (($i == $ancx->sanc_aborsi) ? 'selected' : '') }}>{{ $i }}</option>
                                    @endfor
                                </select>
                            </div>
                        </div>
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-8">
                                <select name="sanc_life" id="sanc_life" class="form-control select2" style=" font-size: 14pt;">
                                    @for ($i = 0; $i < 16; $i++)
                                        <option value="{{ $i }}"  {{ (old('sanc_life') == $i) ? 'selected' : (($i == $ancx->sanc_life) ? 'selected' : '') }}>{{ $i }}</option>
                                    @endfor
                                </select>
                            </div>
                        </div>
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-8">
                                <select name="sanc_death" id="sanc_death" class="form-control select2" style=" font-size: 14pt;">
                                    @for ($i = 0; $i < 16; $i++)
                                        <option value="{{ $i }}"  {{ (old('sanc_death') == $i) ? 'selected' : (($i == $ancx->sanc_death) ? 'selected' : '') }}>{{ $i }}</option>
                                    @endfor
                                </select>
                            </div>
                        </div>
                ...
                <div class="col-md-6">
                    <div class="form-group">
                        <div class="row">
                            ...
                            <div class="col-md-8">
                                <input type="date" name="sanc_hpht" id="sanc_hpht" class="form-control text-center" onchange="counthpl(event);" value="{{ (old('sanc_hpht')) ? old('sanc_hpht') : $ancx->sanc_hpht }}">
                            </div>
                        </div>
                    </div>
                </div>
                <div class="col-md-6">
                    <div class="form-group">
                        <div class="row">
                            ...
                            <div class="col-md-8">
                                <input type="text" name="sanc_hpl" id="sanc_hpl" class="form-control text-center" readonly style="font-size: 18pt;" value="{{ (old('sanc_hpl')) ? old('sanc_hpl') : $ancx->sanc_hpl }}">
                            </div>
                        </div>
                    </div>
                </div>
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-8">
                                <select name="sanc_pregnancy1_age" id="sanc_pregnancy1_age" class="form-control select2" style=" font-size: 14pt;">
                                    ...
                                    @foreach ($sage as $sa)
                                        <option value="{{ $sa->pa_id }}" {{ ($sa->pa_id == old('sanc_pregnancy1_age')) ? 'selected' : (($sa->pa_id == $ancx->sanc_pregnancy1_age) ? 'selected' : '') }}>{{ $sa->pa_name }}</option>
                                    @endforeach
                                </select>
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-8">
                                <select name="sanc_pregnancy1_marriage" id="sanc_pregnancy1_marriage" class="form-control select2" style=" font-size: 14pt;">
                                    ...
                                    @foreach ($spm as $pm)
                                        <option value="{{ $pm->pm_id }}" {{ ($pm->pm_id == old('sanc_pregnancy1_marriage')) ? 'selected' : (($pm->pm_id == $ancx->sanc_pregnancy1_marriage) ? 'selected' : '') }}>{{ $pm->pm_name }}</option>
                                    @endforeach
                                </select>
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-8">
                                <select name="sanc_distance_pregnancy" id="sanc_distance_pregnancy" class="form-control select2" style=" font-size: 14pt;">
                                    <option value="">-- PILIH JARAK --</option>
                                    @foreach ($sdp as $dp)
                                        <option value="{{ $dp->pd_id }}" {{ ($dp->pd_id == old('sanc_distance_pregnancy')) ? 'selected' : (($dp->pd_id == $ancx->sanc_distance_pregnancy) ? 'selected' : '') }}>{{ $dp->pd_name }}</option>
                                    @endforeach
                                </select>
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-8">
                                <select name="sanc_pregnancy_failed" id="sanc_pregnancy_failed" class="form-control select2" style=" font-size: 14pt;">
                                    <option value="">-- PILIH JARAK --</option>
                                    <option value="0" {{ (old('sanc_pregnancy_failed') == '0') ? 'selected' : (($ancx->sanc_pregnancy_failed == '0') ? 'selected' : '') }}>BELUM PERNAH</option>
                                    <option value="1" {{ (old('sanc_pregnancy_failed') == '1') ? 'selected' : (($ancx->sanc_pregnancy_failed == '1') ? 'selected' : '') }}>PERNAH GAGAL HAMIL</option>
                                </select>
                ...
                <div class="col-md-6">
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-8">
                                <select name="sanc_born_with" id="sanc_born_with" class="form-control select2" style=" font-size: 14pt;">
                                    ...
                                    @foreach ($spw as $pw)
                                        <option value="{{ $pw->pw_id }}" {{ ($pw->pw_id == old('sanc_born_with')) ? 'selected' : (($pw->pw_id == $ancx->sanc_born_with) ? 'selected' : '') }}>{{ $pw->pw_name }}</option>
                                    @endforeach
                                </select>
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-8">
                                <select name="sanc_habit" id="sanc_habit" class="form-control select2" style=" font-size: 14pt;">
                                    ...
                                    @foreach ($shab as $hb)
                                        <option value="{{ $hb->hb_id }}" {{ ($hb->hb_id == old('sanc_habit')) ? 'selected' : (($hb->hb_id == $ancx->sanc_habit) ? 'selected' : '') }}>{{ $hb->hb_name }}</option>
                                    @endforeach
                                </select>
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-8">
                                <select name="sanc_menstrual" id="sanc_menstrual" class="form-control select2" style=" font-size: 14pt;">
                                    ...
                                    <option value="0" {{ (old('sanc_menstrual') == '0') ? 'selected' : (($ancx->sanc_menstrual == '0') ? 'selected' : '') }}>TIDAK TERATUR</option>
                                    <option value="1" {{ (old('sanc_menstrual') == '1') ? 'selected' : (($ancx->sanc_menstrual == '1') ? 'selected' : '') }}>TERATUR</option>
                                </select>
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-8">
                                <select name="sanc_menstrual_cycle" id="sanc_menstrual_cycle" class="form-control select2" style=" font-size: 14pt;">
                                    <option value="">-- PILIH SIKLUS --</option>
                                    @foreach ($shaid as $a)
                                        <option value="{{ $a->mc_id }}" {{ ($a->mc_id == old('sanc_menstrual_cycle')) ? 'selected' : (($a->mc_id == $ancx->sanc_menstrual_cycle) ? 'selected' : '') }}>{{ $a->mc_name }}</option>
                                    @endforeach
                                </select>
                    ...
                    <div class="form-group">
                        <div class="row">
                            ...
                            <div class="col-md-8">
                                <textarea name="sanc_illness_experienced" id="sanc_illness_experienced" cols="30" rows="3" class="form-control">{{ (old('sanc_illness_experienced')) ? old('sanc_illness_experienced') : $ancx->sanc_illness_experienced }}</textarea>
                    ...
                    <div class="form-group">
                        <div class="row">
                            ...
                            <div class="col-md-8">
                                <textarea name="sanc_hereditary_disease" id="sanc_hereditary_disease" cols="30" rows="3" class="form-control">{{ (old('sanc_hereditary_disease')) ? old('sanc_hereditary_disease') : $ancx->sanc_hereditary_disease }}</textarea>
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-8">
                                <select name="sanc_hiv_aids" id="sanc_hiv_aids" class="form-control select2" style=" font-size: 14pt;">
                                    ...
                                    <option value="0" {{ (old('sanc_hiv_aids') == '0') ? 'selected' : (($ancx->sanc_hiv_aids == '0') ? 'selected' : '') }}>TIDAK ADA</option>
                                    <option value="1" {{ (old('sanc_hiv_aids') == '1') ? 'selected' : (($ancx->sanc_hiv_aids == '1') ? 'selected' : '') }}>ADA</option>
                                </select>
