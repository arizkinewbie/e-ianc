...
<body>
    ...
    <h3 style="text-align: center; font-size: 10pt;">
        ...
        <br>
        KECAMATAMAN {{ strtoupper($al_subdis) }}
        <br>
    ...
    <table width="100%" style="border-collapse: collapse; border: 1px solid black; font-size: 6pt;">
        <thead>
            <tr style="border: 1px solid black;">
                ...
                <th style="border: 1px solid black; border: 1px solid black; text-align: center;" rowspan="3">Kelurahan/Desa</th>
        ...
        <tbody>
            ...
            @foreach ($subdist as $rw)
                <tr>
                    <td style="text-align: right; border: 1px solid black;">{{ $loop->iteration }}</td>
                    <td style="text-align: left; border: 1px solid black;">{{ DB::table('sys_alamats')->where('kode', $rw->ds_destination)->value('nama') }}</td>
                    ...
                    <td style="border: 1px solid black; border: 1px solid black; text-align: center;">
                        <?php
                            ${'kbal' . $loop->iteration} = DB::table('eianc_instansis')
                                                            ...
                                                            ->where('ins_subdistrict', $ins_subdis)
    ...
    <table width="100%" style="font-size: 8pt; margin-top: 10pt">
        <tr>
            ...
            <td style="text-align: center">
                ...
                {{ $al_dis . ', ' . date('d-m-Y') }}
                <br>
                Pengelola KB Kecamatan {{ $al_subdis }}
                <br>
                <br>
                <br>
                <br>
