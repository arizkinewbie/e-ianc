        ...
        <div class="row">
            <div class="col-md-8">
                <div class="form-group">
                    <div class="row">
                        <div class="col-md-4">
                            <label for="pat_norm">NORM</label>
                        </div>
                        <div class="col-md-8">
                            <input type="text" name="pat_norm" id="pat_norm" class="form-control text-center" value="{{ $data->pat_norm }}" readonly>
                        </div>
                    </div>
                </div>
                <div class="form-group">
                    <div class="row">
                        ...
                        <div class="col-md-8">
                            <input type="text" name="pat_bpjs_kesehatan" id="pat_bpjs_kesehatan" class="form-control" value="{{ (old('pat_bpjs_kesehatan')) ? old('pat_bpjs_kesehatan') : $data->pat_bpjs_kesehatan }}" maxlength="13">
                        </div>
                    </div>
                </div>
                <div class="form-group">
                    <div class="row">
                        ...
                        <div class="col-md-8">
                            <input type="text" name="pat_nik" id="pat_nik" class="form-control" value="{{ (old('pat_nik')) ? old('pat_nik') : $data->pat_nik }}" maxlength="16">
                        </div>
                    </div>
                </div>
                <div class="form-group">
                    <div class="row">
                        ...
                        <div class="col-md-8">
                            <select name="pat_called" id="pat_called" class="form-control text-center select2">
                                ...
                                @foreach ($call as $cal)
                                    <option value="{{ $cal->cal_id }}" {{ (old('pat_called') == $cal->cal_id) ? 'selected' : (($cal->cal_id == $data->pat_called) ? 'selected' : '') }}>{{ $cal->cal_name }}</option>
                                @endforeach
                            </select>
                        ...
                        <div class="col-md-8">
                            <select name="pat_status" id="pat_status" class="form-control text-center select2">
                                ...
                                @foreach ($status as $ssp)
                                    <option value="{{ $ssp->ssp_id }}" {{ (old('pat_status') == $ssp->ssp_id) ? 'selected' : (($ssp->ssp_id == $data->pat_status) ? 'selected' : '') }}>{{ $ssp->ssp_name }}</option>
                                @endforeach
                            </select>
                ...
                <div class="form-group">
                    <div class="row">
                        ...
                        <div class="col-md-8">
                            <input type="text" name="pat_name" id="pat_name" class="form-control" value="{{ (old('pat_name')) ? old('pat_name') : $data->pat_name }}" maxlength="255">
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-8">
                            <select name="pat_sex" id="pat_sex" class="form-control text-center select2">
                                ...
                                @foreach ($sex as $sex)
                                    <option value="{{ $sex->sex_id }}" {{ (old('pat_sex') == $sex->sex_id) ? 'selected' : (($sex->sex_id == $data->pat_sex) ? 'selected' : '') }}>{{ $sex->sex_name }}</option>
                                @endforeach
                            </select>
                        ...
                        <div class="col-md-8">
                            <select name="pat_religion" id="pat_religion" class="form-control text-center select2">
                                ...
                                @foreach ($religion as $rel)
                                    <option value="{{ $rel->rel_id }}" {{ (old('pat_religion') == $rel->rel_id) ? 'selected' : (($rel->rel_id == $data->pat_religion) ? 'selected' : '') }}>{{ $rel->rel_name }}</option>
                                @endforeach
                            </select>
                ...
                <div class="form-group">
                    <div class="row">
                        ...
                        <div class="col-md-8">
                            <input type="text" name="pat_pob" id="pat_pob" class="form-control" value="{{ (old('pat_pob')) ? old('pat_pob') : $data->pat_pob }}" maxlength="255">
                ...
                <div class="form-group">
                    <div class="row">
                        ...
                        <div class="col-md-8">
                            <input type="date" name="pat_dob" id="pat_dob" class="form-control" value="{{ (old('pat_dob')) ? old('pat_dob') : $data->pat_dob }}">
                ...
                <div class="form-group">
                    <div class="row">
                        ...
                        <div class="col-md-8">
                            <input type="time" name="pat_tob" id="pat_tob" class="form-control" value="{{ (old('pat_tob')) ? old('pat_tob') : $data->pat_tob }}">
                        </div>
                    </div>
                </div>
                <div class="form-group">
                        ...
                        <div class="col-md-8">
                            <select name="pat_education" id="pat_education" class="form-control text-center select2">
                                ...
                                @foreach ($education as $edu)
                                    <option value="{{ $edu->edu_id }}" {{ (old('pat_education') == $edu->edu_id) ? 'selected' : (($edu->edu_id == $data->pat_education) ? 'selected' : '') }}>{{ $edu->edu_name }}</option>
                                @endforeach
                            </select>
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-8">
                            <select name="pat_work" id="pat_work" class="form-control text-center select2">
                                ...
                                @foreach ($work as $w)
                                    <option value="{{ $w->w_id }}" {{ (old('pat_work') == $w->w_id) ? 'selected' : (($w->w_id == $data->pat_work) ? 'selected' : '') }}>{{ $w->w_name }}</option>
                                @endforeach
                            </select>
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-8">
                            <select name="pat_blood" id="pat_blood" class="form-control text-center select2">
                                ...
                                @foreach ($blood as $bl)
                                    <option value="{{ $bl->blo_id }}" {{ (old('pat_blood') == $bl->blo_id) ? 'selected' : (($bl->blo_id == $data->pat_blood) ? 'selected' : '') }}>{{ $bl->blo_name }}</option>
                                @endforeach
                            </select>
                        ...
                        <div class="col-md-8">
                            <select name="pat_marital" id="pat_marital" class="form-control text-center select2">
                                ...
                                @foreach ($marital as $mr)
                                    <option value="{{ $mr->mar_id }}" {{ (old('pat_marital') == $mr->mar_id) ? 'selected' : (($mr->mar_id == $data->pat_marital) ? 'selected' : '') }}>{{ $mr->mar_name }}</option>
                                @endforeach
                            </select>
                ...
                <div class="form-group">
                    <div class="row">
                        ...
                        <div class="col-md-8">
                            <input type="text" name="pat_telp" id="pat_telp" class="form-control" value="{{ (old('pat_telp')) ? old('pat_telp') : $data->pat_telp }}" maxlength="15">
                ...
                <div class="form-group">
                    <div class="row">
                        ...
                        <div class="col-md-8">
                            <input type="text" name="pat_biological_mother" id="pat_biological_mother" class="form-control" value="{{ (old('pat_biological_mother')) ? old('pat_biological_mother') : $data->pat_biological_mother }}" maxlength="255">
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-8">
                            <select name="pat_province" id="pat_province" class="form-control select2">
                                ...
                                <option value="{{ $pro->kode }}" {{ ($pro->kode == $data->pat_province) ? 'selected' : '' }}>{{ $pro->nama }}</option>
                                @endforeach
                            </select>
                        </div>
                    </div>
                ...
                <div class="form-group">
                    <div class="row">
                        ...
                        <div class="col-md-8">
                            <select name="pat_district" id="pat_district" class="form-control select2">
                                @php
                                    $kab = DB::table('sys_alamats')->where('kode', $data->pat_district)->get();
                                @endphp
                ...
                <div class="form-group">
                    <div class="row">
                        ...
                        <div class="col-md-8">
                            <select name="pat_subdistrict" id="pat_subdistrict" class="form-control select2">
                                @php
                                    $kab = DB::table('sys_alamats')->where('kode', $data->pat_subdistrict)->get();
                                @endphp
                                <option value="{{ $kab[0]->kode }}">{{ $kab[0]->nama }}</option>
                            </select>
                        </div>
                ...
                <div class="form-group">
                    <div class="row">
                        ...
                        <div class="col-md-8">
                            <select name="pat_village" id="pat_village" class="form-control select2">
                                @php
                                    $kab = DB::table('sys_alamats')->where('kode', $data->pat_village)->get();
                                @endphp
                                <option value="{{ $kab[0]->kode }}">{{ $kab[0]->nama }}</option>
                            </select>
                            ...
                            <div class="row">
                                <div class="col-md-6">
                                    ...
                                    <input type="text" name="pat_rw" id="pat_rw" class="form-control text-center"
                                        value="{{ (old('pat_rw')) ? old('pat_rw') : $data->pat_rw }}">
                                ...
                                <div class="col-md-6">
                                    ...
                                    <input type="text" name="pat_rt" id="pat_rt" class="form-control text-center"
                                        value="{{ (old('pat_rt')) ? old('pat_rt') : $data->pat_rt }}">
                ...
                <div class="form-group">
                    <div class="row">
                        ...
                        <div class="col-md-8">
                            <textarea name="pat_address" id="pat_address" cols="30" rows="3" class="form-control">{{ (old('pat_address')) ? old('pat_address') : $data->pat_address }}</textarea>
                ...
                <div class="form-group">
                    <div class="row">
                        ...
                        <div class="col-md-8">
                            <input type="text" name="pat_zip_code" id="pat_zip_code" class="form-control text-center" value="{{ (old('pat_zip_code')) ? old('pat_zip_code') : $data->pat_zip_code }}">
                        </div>
                    </div>
                </div>
            </div>
                ...
                <div class="col-md-6">
                    <div class="form-group">
                        <div class="row">
                            ...
                            <div class="col-md-8">
                                <input type="text" name="pat_husband_nik" id="pat_husband_nik" class="form-control" value="{{ (old('pat_husband_nik')) ? old('pat_husband_nik') : $data->pat_husband_nik }}">
                            </div>
                        </div>
                    </div>
                    <div class="form-group">
                        <div class="row">
                            ...
                            <div class="col-md-8">
                                <input type="text" name="pat_husband" id="pat_husband" class="form-control" value="{{ (old('pat_husband')) ? old('pat_husband') : $data->pat_husband }}">
                            </div>
                        </div>
                    </div>
                    <div class="form-group">
                        <div class="row">
                            ...
                            <div class="col-md-8">
                                <select name="pat_husband_work" id="pat_husband_work" class="form-control text-center select2">
                                    <option value="">-- PILIH PEKERJAAN --</option>
                                    @foreach ($work as $w)
                                        <option value="{{ $w->w_id }}" {{ (old('pat_husband_work') == $w->w_id) ? 'selected' : (($w->w_id == $data->pat_husband_work) ? 'selected' : '') }}>{{ $w->w_name }}</option>
                                    @endforeach
                                </select>
                            </div>
                        </div>
                    ...
                    <div class="form-group">
                        <div class="row">
                            ...
                            <div class="col-md-8">
                                <input type="text" name="pat_wife_nik" id="pat_wife_nik" class="form-control" value="{{ (old('pat_wife_nik')) ? old('pat_wife_nik') : $data->pat_wife_nik }}">
                            </div>
                        </div>
                    </div>
                    <div class="form-group">
                        <div class="row">
                            ...
                            <div class="col-md-8">
                                <input type="text" name="pat_wife" id="pat_wife" class="form-control" value="{{ (old('pat_wife')) ? old('pat_wife') : $data->pat_wife }}">
                            </div>
                        </div>
                    </div>
                    <div class="form-group">
                        <div class="row">
                            ...
                            <div class="col-md-8">
                                <select name="pat_wife_work" id="pat_wife_work" class="form-control text-center select2">
                                    <option value="">-- PILIH PEKERJAAN --</option>
                                    @foreach ($work as $w)
                                        <option value="{{ $w->w_id }}" {{ (old('pat_wife_work') == $w->w_id) ? 'selected' : (($w->w_id == $data->pat_wife_work) ? 'selected' : '') }}>{{ $w->w_name }}</option>
                                    @endforeach
                                </select>
                            </div>
                        </div>
                ...
                <div class="col-md-6">
                    <div class="form-group">
                        <div class="row">
                            ...
                            <div class="col-md-8">
                                <input type="text" name="pat_father_nik" id="pat_father_nik" class="form-control" value="{{ (old('pat_father_nik')) ? old('pat_father_nik') : $data->pat_father_nik }}">
                            </div>
                        </div>
                    </div>
                    <div class="form-group">
                        <div class="row">
                            ...
                            <div class="col-md-8">
                                <input type="text" name="pat_father" id="pat_father" class="form-control" value="{{ (old('pat_father')) ? old('pat_father') : $data->pat_father }}">
                            </div>
                        </div>
                    </div>
                    <div class="form-group">
                        <div class="row">
                            ...
                            <div class="col-md-8">
                                <select name="pat_father_work" id="pat_father_work" class="form-control text-center select2">
                                    <option value="">-- PILIH PEKERJAAN --</option>
                                    @foreach ($work as $w)
                                        <option value="{{ $w->w_id }}" {{ (old('pat_father_work') == $w->w_id) ? 'selected' : (($w->w_id == $data->pat_father_work) ? 'selected' : '') }}>{{ $w->w_name }}</option>
                                    @endforeach
                                </select>
                            </div>
                        </div>
                    ...
                    <div class="form-group">
                        <div class="row">
                            ...
                            <div class="col-md-8">
                                <input type="text" name="pat_mother_nik" id="pat_mother_nik" class="form-control" value="{{ (old('pat_mother_nik')) ? old('pat_mother_nik') : $data->pat_mother_nik }}">
                            </div>
                        </div>
                    </div>
                    <div class="form-group">
                        <div class="row">
                            ...
                            <div class="col-md-8">
                                <input type="text" name="pat_mother" id="pat_mother" class="form-control" value="{{ (old('pat_mother')) ? old('pat_mother') : $data->pat_mother }}">
                            </div>
                        </div>
                    </div>
                    <div class="form-group">
                        <div class="row">
                            ...
                            <div class="col-md-8">
                                <select name="pat_mother_work" id="pat_mother_work" class="form-control text-center select2">
                                    <option value="">-- PILIH PEKERJAAN --</option>
                                    @foreach ($work as $w)
                                        <option value="{{ $w->w_id }}" {{ (old('pat_mother_work') == $w->w_id) ? 'selected' : (($w->w_id == $data->pat_mother_work) ? 'selected' : '') }}>{{ $w->w_name }}</option>
                                    @endforeach
                                </select>
                            </div>
                        </div>
