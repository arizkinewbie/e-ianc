...
<div class="col-sm-6 text-right">
    ...
    &nbsp;&nbsp;|&nbsp;&nbsp;
    <a href="{{ route('service.neobb.create', ['id' => $id, 'idx' => Crypt::encrypt(0)]) }}">
            ...
            <tbody>
                @foreach ($data as $d)
                    <tr>
                        ...
                        <td class="text-center">{{ $d->neobb_date }}</td>
                        <td>
                            <div class="row">
                                ...
                                <div class="col-md-8">
                                    Berat Badan : <b>{{ $d->neobb_nut_weight }} gram</b>
                                    <br>
                                    Panjang Badan : <b>{{ $d->neobb_nut_height }} cm</b>
                                </div>
                            </div>
                        </td>
                        <td class="text-center">
                            <?php
                                ...
                                $par1 = DB::table('users')->where('id', $d->neobb_user_id)
                            ...
                            <a href="{{ route('service.neobb.create', ['id' => $id, 'idx' => Crypt::encrypt($d->neobb_id)]) }}" class="{{ $isdis }}">
                                <button class="btn btn-warning" title="edit">
                                    <i class="fas fa-edit"></i>
                                </button>
                            </a>
                            &nbsp;|&nbsp;
                            <form action="{{ route('service.neo.destroy') }}" method="post" class="d-inline">
                                @csrf
                                <input type="hidden" name="id" value="{{ $d->neobb_id }}">
