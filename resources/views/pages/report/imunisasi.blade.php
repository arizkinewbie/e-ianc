...
<div class="row justify-content-center">
    <div class="col-md-3">
        <div class="card">
            <form action="{{ route('report.imunisasi.cek') }}" method="post" autocomplete="off">
                @csrf
                <div class="card-body">
...
<script>
    window.open("{{ route('report.imunisasi.view', ['month' => session()->get('rmonth'), 'year' => session()->get('ryear')]) }}", "_blank", "toolbar=yes,scrollbars=yes,resizable=yes,top=100,left=100,width=1270,height=720");
</script>
@endif
@endsection
