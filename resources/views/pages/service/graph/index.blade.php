...
<div class="card">
    <div class="card-header">
        <h5>
            <b>Grafik Berat Badan 0 - 2 Tahun</b>
        </h5>
    </div>
    <div class="card-body">
        <table width="100%" style="background-color: white;" border="1">
            <tbody>
                <tr>
                    <td class="rotate text-center" rowspan="18" style="font-size: 18pt; font-weight:bold;">Berat Badan (Kg)</td>
                    <td class="text-center" width="3%" style="background-color: pink">18</td>
                    @for ($i = 0; $i < 25; $i++)
                        <td class="text-center" style="background-color: rgb(163, 255, 255);">
                            @for ($x = 0; $x < count($tb28); $x++)
                                @if (floor($tb28[$x]['neo28_weigth']/1000) >= 18 && $i == 0)
                                    <img src="{{ asset('data/image/graph/blue.png') }}" alt="" width="16" title="Tgl : {{ $tb28[$x]['neo28_date'] }}, BB : {{ $tb28[$x]['neo28_weigth']/1000 }} Kg">
                                @endif
                            @endfor

                            @for ($y = 0; $y < count($tb02); $y++)
                                @if (date('Y-m', strtotime($tb02[$y]['neobb_date'])) == date('Y-m', strtotime($pas[0]['pat_dob'] . "+" . $i . " months")) && floor($tb02[$y]['neobb_nut_weight']/1000) >= 18)
                                    <img src="{{ asset('data/image/graph/green.png') }}" alt="" width="16" title="Tgl : {{ $tb02[$y]['neobb_date'] }}, BB : {{ $tb02[$y]['neobb_nut_weight']/1000 }} Kg">
                                @endif
                            @endfor
                        </td>
                    @endfor
                ...
                <tr>
                    ...
                    @for ($i = 0; $i < 25; $i++)
                        <td class="text-center" style="background-color: rgb(163, 255, 255);">
                            @for ($x = 0; $x < count($tb28); $x++)
                                @if (floor($tb28[$x]['neo28_weigth']/1000) >= 17 && floor($tb28[$x]['neo28_weigth']/1000) < 18 && $i == 0)
                                    <img src="{{ asset('data/image/graph/blue.png') }}" alt="" width="16" title="Tgl : {{ $tb28[$x]['neo28_date'] }}, BB : {{ $tb28[$x]['neo28_weigth']/1000 }} Kg">
                                @endif
                            @endfor

                            @for ($y = 0; $y < count($tb02); $y++)
                                @if (date('Y-m', strtotime($tb02[$y]['neobb_date'])) == date('Y-m', strtotime($pas[0]['pat_dob'] . "+" . $i . " months")) && floor($tb02[$y]['neobb_nut_weight']/1000) >= 17 && floor($tb02[$y]['neobb_nut_weight']/1000) < 18)
                                    <img src="{{ asset('data/image/graph/green.png') }}" alt="" width="16" title="Tgl : {{ $tb02[$y]['neobb_date'] }}, BB : {{ $tb02[$y]['neobb_nut_weight']/1000 }} Kg">
                                @endif
                            @endfor
                        </td>
                ...
                <tr>
                    ...
                    @for ($i = 0; $i < 25; $i++)
                        <td class="text-center" style="background-color: rgb(163, 255, 255);">
                            @for ($x = 0; $x < count($tb28); $x++)
                                @if (floor($tb28[$x]['neo28_weigth']/1000) >= 16 && floor($tb28[$x]['neo28_weigth']/1000) < 17 && $i == 0)
                                    <img src="{{ asset('data/image/graph/blue.png') }}" alt="" width="16" title="Tgl : {{ $tb28[$x]['neo28_date'] }}, BB : {{ $tb28[$x]['neo28_weigth']/1000 }} Kg">
                                @endif
                            @endfor

                            @for ($y = 0; $y < count($tb02); $y++)
                                @if (date('Y-m', strtotime($tb02[$y]['neobb_date'])) == date('Y-m', strtotime($pas[0]['pat_dob'] . "+" . $i . " months")) && floor($tb02[$y]['neobb_nut_weight']/1000) >= 16 && floor($tb02[$y]['neobb_nut_weight']/1000) < 17)
                                    <img src="{{ asset('data/image/graph/green.png') }}" alt="" width="16" title="Tgl : {{ $tb02[$y]['neobb_date'] }}, BB : {{ $tb02[$y]['neobb_nut_weight']/1000 }} Kg">
                                @endif
                            @endfor
                        </td>
                ...
                <tr>
                    ...
                    @for ($i = 0; $i < 25; $i++)
                        <td class="text-center" style="background-color: rgb(163, 255, 255);">
                            @for ($x = 0; $x < count($tb28); $x++)
                                @if (floor($tb28[$x]['neo28_weigth']/1000) >= 15 && floor($tb28[$x]['neo28_weigth']/1000) < 16 && $i == 0)
                                    <img src="{{ asset('data/image/graph/blue.png') }}" alt="" width="16" title="Tgl : {{ $tb28[$x]['neo28_date'] }}, BB : {{ $tb28[$x]['neo28_weigth']/1000 }} Kg">
                                @endif
                            @endfor

                            @for ($y = 0; $y < count($tb02); $y++)
                                @if (date('Y-m', strtotime($tb02[$y]['neobb_date'])) == date('Y-m', strtotime($pas[0]['pat_dob'] . "+" . $i . " months")) && floor($tb02[$y]['neobb_nut_weight']/1000) >= 15 && floor($tb02[$y]['neobb_nut_weight']/1000) < 16)
                                    <img src="{{ asset('data/image/graph/green.png') }}" alt="" width="16" title="Tgl : {{ $tb02[$y]['neobb_date'] }}, BB : {{ $tb02[$y]['neobb_nut_weight']/1000 }} Kg">
                                @endif
                            @endfor
                        </td>
                ...
                <tr>
                    ...
                    @for ($i = 0; $i < 25; $i++)
                        <td class="text-center" style="background-color: rgb(163, 255, 255);">
                            @for ($x = 0; $x < count($tb28); $x++)
                                @if (floor($tb28[$x]['neo28_weigth']/1000) >= 14 && floor($tb28[$x]['neo28_weigth']/1000) < 15 && $i == 0)
                                    <img src="{{ asset('data/image/graph/blue.png') }}" alt="" width="16" title="Tgl : {{ $tb28[$x]['neo28_date'] }}, BB : {{ $tb28[$x]['neo28_weigth']/1000 }} Kg">
                                @endif
                            @endfor

                            @for ($y = 0; $y < count($tb02); $y++)
                                @if (date('Y-m', strtotime($tb02[$y]['neobb_date'])) == date('Y-m', strtotime($pas[0]['pat_dob'] . "+" . $i . " months")) && floor($tb02[$y]['neobb_nut_weight']/1000) >= 14 && floor($tb02[$y]['neobb_nut_weight']/1000) < 15)
                                    <img src="{{ asset('data/image/graph/green.png') }}" alt="" width="16" title="Tgl : {{ $tb02[$y]['neobb_date'] }}, BB : {{ $tb02[$y]['neobb_nut_weight']/1000 }} Kg">
                                @endif
                            @endfor
                        </td>
                ...
                <tr>
                    ...
                    @for ($i = 0; $i < 25; $i++)
                        <td class="text-center" style="background-color: rgb(163, 255, 255);">
                            @for ($x = 0; $x < count($tb28); $x++)
                                @if (floor($tb28[$x]['neo28_weigth']/1000) >= 13 && floor($tb28[$x]['neo28_weigth']/1000) < 14 && $i == 0)
                                    <img src="{{ asset('data/image/graph/blue.png') }}" alt="" width="16" title="Tgl : {{ $tb28[$x]['neo28_date'] }}, BB : {{ $tb28[$x]['neo28_weigth']/1000 }} Kg">
                                @endif
                            @endfor

                            @for ($y = 0; $y < count($tb02); $y++)
                                @if (date('Y-m', strtotime($tb02[$y]['neobb_date'])) == date('Y-m', strtotime($pas[0]['pat_dob'] . "+" . $i . " months")) && floor($tb02[$y]['neobb_nut_weight']/1000) >= 13 && floor($tb02[$y]['neobb_nut_weight']/1000) < 14)
                                    <img src="{{ asset('data/image/graph/green.png') }}" alt="" width="16" title="Tgl : {{ $tb02[$y]['neobb_date'] }}, BB : {{ $tb02[$y]['neobb_nut_weight']/1000 }} Kg">
                                @endif
                            @endfor
                        </td>
                ...
                <tr>
                    ...
                    @for ($i = 0; $i < 25; $i++)
                        <td class="text-center" style="background-color: rgb(163, 255, 255);">
                            ...
                            @for ($x = 0; $x < count($tb28); $x++)
                                @if (floor($tb28[$x]['neo28_weigth']/1000) >= 12 && floor($tb28[$x]['neo28_weigth']/1000) < 13 && $i == 0)
                                    <img src="{{ asset('data/image/graph/blue.png') }}" alt="" width="16" title="Tgl : {{ $tb28[$x]['neo28_date'] }}, BB : {{ $tb28[$x]['neo28_weigth']/1000 }} Kg">
                                @endif
                            @endfor

                            @for ($y = 0; $y < count($tb02); $y++)
                                @if (date('Y-m', strtotime($tb02[$y]['neobb_date'])) == date('Y-m', strtotime($pas[0]['pat_dob'] . "+" . $i . " months")) && floor($tb02[$y]['neobb_nut_weight']/1000) >= 12 && floor($tb02[$y]['neobb_nut_weight']/1000) < 13)
                                    <img src="{{ asset('data/image/graph/green.png') }}" alt="" width="16" title="Tgl : {{ $tb02[$y]['neobb_date'] }}, BB : {{ $tb02[$y]['neobb_nut_weight']/1000 }} Kg">
                                @endif
                            @endfor
                        </td>
                ...
                <tr>
                    ...
                    @for ($i = 0; $i < 25; $i++)
                        <td class="text-center" style="background-color: rgb(163, 255, 255);">
                            ...
                            @for ($x = 0; $x < count($tb28); $x++)
                                @if (floor($tb28[$x]['neo28_weigth']/1000) >= 11 && floor($tb28[$x]['neo28_weigth']/1000) < 12 && $i == 0)
                                    <img src="{{ asset('data/image/graph/blue.png') }}" alt="" width="16" title="Tgl : {{ $tb28[$x]['neo28_date'] }}, BB : {{ $tb28[$x]['neo28_weigth']/1000 }} Kg">
                                @endif
                            @endfor

                            @for ($y = 0; $y < count($tb02); $y++)
                                @if (date('Y-m', strtotime($tb02[$y]['neobb_date'])) == date('Y-m', strtotime($pas[0]['pat_dob'] . "+" . $i . " months")) && floor($tb02[$y]['neobb_nut_weight']/1000) >= 11 && floor($tb02[$y]['neobb_nut_weight']/1000) < 12)
                                    <img src="{{ asset('data/image/graph/green.png') }}" alt="" width="16" title="Tgl : {{ $tb02[$y]['neobb_date'] }}, BB : {{ $tb02[$y]['neobb_nut_weight']/1000 }} Kg">
                                @endif
                            @endfor
                        </td>
                ...
                <tr>
                    ...
                    @for ($i = 0; $i < 25; $i++)
                        <td class="text-center" style="background-color: rgb(163, 255, 255);">
                            ...
                            @for ($x = 0; $x < count($tb28); $x++)
                                @if (floor($tb28[$x]['neo28_weigth']/1000) >= 10 && floor($tb28[$x]['neo28_weigth']/1000) < 11 && $i == 0)
                                    <img src="{{ asset('data/image/graph/blue.png') }}" alt="" width="16" title="Tgl : {{ $tb28[$x]['neo28_date'] }}, BB : {{ $tb28[$x]['neo28_weigth']/1000 }} Kg">
                                @endif
                            @endfor

                            @for ($y = 0; $y < count($tb02); $y++)
                                @if (date('Y-m', strtotime($tb02[$y]['neobb_date'])) == date('Y-m', strtotime($pas[0]['pat_dob'] . "+" . $i . " months")) && floor($tb02[$y]['neobb_nut_weight']/1000) >= 10 && floor($tb02[$y]['neobb_nut_weight']/1000) < 11)
                                    <img src="{{ asset('data/image/graph/green.png') }}" alt="" width="16" title="Tgl : {{ $tb02[$y]['neobb_date'] }}, BB : {{ $tb02[$y]['neobb_nut_weight']/1000 }} Kg">
                                @endif
                            @endfor
                        </td>
                ...
                <tr>
                    ...
                    @for ($i = 0; $i < 25; $i++)
                        <td class="text-center" style="background-color: rgb(163, 255, 255);">
                            ...
                            @for ($x = 0; $x < count($tb28); $x++)
                                @if (floor($tb28[$x]['neo28_weigth']/1000) >= 9 && floor($tb28[$x]['neo28_weigth']/1000) < 10 && $i == 0)
                                    <img src="{{ asset('data/image/graph/blue.png') }}" alt="" width="16" title="Tgl : {{ $tb28[$x]['neo28_date'] }}, BB : {{ $tb28[$x]['neo28_weigth']/1000 }} Kg">
                                @endif
                            @endfor

                            @for ($y = 0; $y < count($tb02); $y++)
                                @if (date('Y-m', strtotime($tb02[$y]['neobb_date'])) == date('Y-m', strtotime($pas[0]['pat_dob'] . "+" . $i . " months")) && floor($tb02[$y]['neobb_nut_weight']/1000) >= 9 && floor($tb02[$y]['neobb_nut_weight']/1000) < 10)
                                    <img src="{{ asset('data/image/graph/green.png') }}" alt="" width="16" title="Tgl : {{ $tb02[$y]['neobb_date'] }}, BB : {{ $tb02[$y]['neobb_nut_weight']/1000 }} Kg">
                                @endif
                            @endfor
                        </td>
                ...
                <tr>
                    ...
                    @for ($i = 0; $i < 25; $i++)
                        <td class="text-center" style="background-color: rgb(163, 255, 255);">
                            ...
                            @for ($x = 0; $x < count($tb28); $x++)
                                @if (floor($tb28[$x]['neo28_weigth']/1000) >= 8 && floor($tb28[$x]['neo28_weigth']/1000) < 9 && $i == 0)
                                    <img src="{{ asset('data/image/graph/blue.png') }}" alt="" width="16" title="Tgl : {{ $tb28[$x]['neo28_date'] }}, BB : {{ $tb28[$x]['neo28_weigth']/1000 }} Kg">
                                @endif
                            @endfor

                            @for ($y = 0; $y < count($tb02); $y++)
                                @if (date('Y-m', strtotime($tb02[$y]['neobb_date'])) == date('Y-m', strtotime($pas[0]['pat_dob'] . "+" . $i . " months")) && floor($tb02[$y]['neobb_nut_weight']/1000) >= 8 && floor($tb02[$y]['neobb_nut_weight']/1000) < 9)
                                    <img src="{{ asset('data/image/graph/green.png') }}" alt="" width="16" title="Tgl : {{ $tb02[$y]['neobb_date'] }}, BB : {{ $tb02[$y]['neobb_nut_weight']/1000 }} Kg">
                                @endif
                            @endfor
                        </td>
                ...
                <tr>
                    ...
                    @for ($i = 0; $i < 25; $i++)
                        <td class="text-center" style="background-color: rgb(163, 255, 255);">
                            ...
                            @for ($x = 0; $x < count($tb28); $x++)
                                @if (floor($tb28[$x]['neo28_weigth']/1000) >= 7 && floor($tb28[$x]['neo28_weigth']/1000) < 8 && $i == 0)
                                    <img src="{{ asset('data/image/graph/blue.png') }}" alt="" width="16" title="Tgl : {{ $tb28[$x]['neo28_date'] }}, BB : {{ $tb28[$x]['neo28_weigth']/1000 }} Kg">
                                @endif
                            @endfor

                            @for ($y = 0; $y < count($tb02); $y++)
                                @if (date('Y-m', strtotime($tb02[$y]['neobb_date'])) == date('Y-m', strtotime($pas[0]['pat_dob'] . "+" . $i . " months")) && floor($tb02[$y]['neobb_nut_weight']/1000) >= 7 && floor($tb02[$y]['neobb_nut_weight']/1000) < 8)
                                    <img src="{{ asset('data/image/graph/green.png') }}" alt="" width="16" title="Tgl : {{ $tb02[$y]['neobb_date'] }}, BB : {{ $tb02[$y]['neobb_nut_weight']/1000 }} Kg">
                                @endif
                            @endfor
                        </td>
                ...
                <tr>
                    ...
                    @for ($i = 0; $i < 25; $i++)
                        <td class="text-center" style="background-color: rgb(163, 255, 255);">
                            ...
                            @for ($x = 0; $x < count($tb28); $x++)
                                @if (floor($tb28[$x]['neo28_weigth']/1000) >= 6 && floor($tb28[$x]['neo28_weigth']/1000) < 7 && $i == 0)
                                    <img src="{{ asset('data/image/graph/blue.png') }}" alt="" width="16" title="Tgl : {{ $tb28[$x]['neo28_date'] }}, BB : {{ $tb28[$x]['neo28_weigth']/1000 }} Kg">
                                @endif
                            @endfor

                            @for ($y = 0; $y < count($tb02); $y++)
                                @if (date('Y-m', strtotime($tb02[$y]['neobb_date'])) == date('Y-m', strtotime($pas[0]['pat_dob'] . "+" . $i . " months")) && floor($tb02[$y]['neobb_nut_weight']/1000) >= 6 && floor($tb02[$y]['neobb_nut_weight']/1000) < 7)
                                    <img src="{{ asset('data/image/graph/green.png') }}" alt="" width="16" title="Tgl : {{ $tb02[$y]['neobb_date'] }}, BB : {{ $tb02[$y]['neobb_nut_weight']/1000 }} Kg">
                                @endif
                            @endfor
                        </td>
                ...
                <tr>
                    ...
                    @for ($i = 0; $i < 25; $i++)
                        <td class="text-center" style="background-color: rgb(163, 255, 255);">
                            ...
                            @for ($x = 0; $x < count($tb28); $x++)
                                @if (floor($tb28[$x]['neo28_weigth']/1000) >= 5 && floor($tb28[$x]['neo28_weigth']/1000) < 6 && $i == 0)
                                    <img src="{{ asset('data/image/graph/blue.png') }}" alt="" width="16" title="Tgl : {{ $tb28[$x]['neo28_date'] }}, BB : {{ $tb28[$x]['neo28_weigth']/1000 }} Kg">
                                @endif
                            @endfor

                            @for ($y = 0; $y < count($tb02); $y++)
                                @if (date('Y-m', strtotime($tb02[$y]['neobb_date'])) == date('Y-m', strtotime($pas[0]['pat_dob'] . "+" . $i . " months")) && floor($tb02[$y]['neobb_nut_weight']/1000) >= 5 && floor($tb02[$y]['neobb_nut_weight']/1000) < 6)
                                    <img src="{{ asset('data/image/graph/green.png') }}" alt="" width="16" title="Tgl : {{ $tb02[$y]['neobb_date'] }}, BB : {{ $tb02[$y]['neobb_nut_weight']/1000 }} Kg">
                                @endif
                            @endfor
                        </td>
                ...
                <tr>
                    ...
                    @for ($i = 0; $i < 25; $i++)
                        <td class="text-center" style="background-color: rgb(163, 255, 255);">
                            ...
                            @for ($x = 0; $x < count($tb28); $x++)
                                @if (floor($tb28[$x]['neo28_weigth']/1000) >= 4 && floor($tb28[$x]['neo28_weigth']/1000) < 5 && $i == 0)
                                    <img src="{{ asset('data/image/graph/blue.png') }}" alt="" width="16" title="Tgl : {{ $tb28[$x]['neo28_date'] }}, BB : {{ $tb28[$x]['neo28_weigth']/1000 }} Kg">
                                @endif
                            @endfor

                            @for ($y = 0; $y < count($tb02); $y++)
                                @if (date('Y-m', strtotime($tb02[$y]['neobb_date'])) == date('Y-m', strtotime($pas[0]['pat_dob'] . "+" . $i . " months")) && floor($tb02[$y]['neobb_nut_weight']/1000) >= 4 && floor($tb02[$y]['neobb_nut_weight']/1000) < 5)
                                    <img src="{{ asset('data/image/graph/green.png') }}" alt="" width="16" title="Tgl : {{ $tb02[$y]['neobb_date'] }}, BB : {{ $tb02[$y]['neobb_nut_weight']/1000 }} Kg">
                                @endif
                            @endfor
                        </td>
                ...
                <tr>
                    ...
                    @for ($i = 0; $i < 25; $i++)
                        <td class="text-center" style="background-color: rgb(163, 255, 255);">
                            ...
                            @for ($x = 0; $x < count($tb28); $x++)
                                @if (floor($tb28[$x]['neo28_weigth']/1000) >= 3 && floor($tb28[$x]['neo28_weigth']/1000) < 4 && $i == 0)
                                    <img src="{{ asset('data/image/graph/blue.png') }}" alt="" width="16" title="Tgl : {{ $tb28[$x]['neo28_date'] }}, BB : {{ $tb28[$x]['neo28_weigth']/1000 }} Kg">
                                @endif
                            @endfor

                            @for ($y = 0; $y < count($tb02); $y++)
                                @if (date('Y-m', strtotime($tb02[$y]['neobb_date'])) == date('Y-m', strtotime($pas[0]['pat_dob'] . "+" . $i . " months")) && floor($tb02[$y]['neobb_nut_weight']/1000) >= 3 && floor($tb02[$y]['neobb_nut_weight']/1000) < 4)
                                    <img src="{{ asset('data/image/graph/green.png') }}" alt="" width="16" title="Tgl : {{ $tb02[$y]['neobb_date'] }}, BB : {{ $tb02[$y]['neobb_nut_weight']/1000 }} Kg">
                                @endif
                            @endfor
                        </td>
                ...
                <tr>
                    ...
                    @for ($i = 0; $i < 25; $i++)
                        <td class="text-center" style="background-color: rgb(163, 255, 255);">
                            @for ($x = 0; $x < count($tb28); $x++)
                                @if (floor($tb28[$x]['neo28_weigth']/1000) >= 2 && floor($tb28[$x]['neo28_weigth']/1000) < 3 && $i == 0)
                                    <img src="{{ asset('data/image/graph/blue.png') }}" alt="" width="16" title="Tgl : {{ $tb28[$x]['neo28_date'] }}, BB : {{ $tb28[$x]['neo28_weigth']/1000 }} Kg">
                                @endif
                            @endfor

                            @for ($y = 0; $y < count($tb02); $y++)
                                @if (date('Y-m', strtotime($tb02[$y]['neobb_date'])) == date('Y-m', strtotime($pas[0]['pat_dob'] . "+" . $i . " months")) && floor($tb02[$y]['neobb_nut_weight']/1000) >= 2 && floor($tb02[$y]['neobb_nut_weight']/1000) < 3)
                                    <img src="{{ asset('data/image/graph/green.png') }}" alt="" width="16" title="Tgl : {{ $tb02[$y]['neobb_date'] }}, BB : {{ $tb02[$y]['neobb_nut_weight']/1000 }} Kg">
                                @endif
                            @endfor
                        </td>
                ...
                <tr>
                    ...
                    @for ($i = 0; $i < 25; $i++)
                        <td class="text-center" style="background-color: rgb(163, 255, 255);">
                            @for ($x = 0; $x < count($tb28); $x++)
                                @if (floor($tb28[$x]['neo28_weigth']/1000) <= 2 && $i == 0)
                                    <img src="{{ asset('data/image/graph/blue.png') }}" alt="" width="16" title="Tgl : {{ $tb28[$x]['neo28_date'] }}, BB : {{ $tb28[$x]['neo28_weigth']/1000 }} Kg">
                                @endif
                            @endfor

                            @for ($y = 0; $y < count($tb02); $y++)
                                @if (date('Y-m', strtotime($tb02[$y]['neobb_date'])) == date('Y-m', strtotime($pas[0]['pat_dob'] . "+" . $i . " months")) && floor($tb02[$y]['neobb_nut_weight']/1000) <= 2)
                                    <img src="{{ asset('data/image/graph/green.png') }}" alt="" width="16" title="Tgl : {{ $tb02[$y]['neobb_date'] }}, BB : {{ $tb02[$y]['neobb_nut_weight']/1000 }} Kg">
                                @endif
                            @endfor
                        </td>
                ...
                <tr>
                    <td class="text-right" colspan="2" style="background-color: rgb(255, 211, 130)"><b>Umur (Bulan)</b></td>
                    @for ($i = 0; $i < 25; $i++)
                        <td class="text-center" width="3.5%" style="background-color: rgb(255, 211, 130)"><b>{{ $i }}</b></td>
                    @endfor
                </tr>
            </tbody>
        </table>
        <div>
            ...
            <img src="{{ asset('data/image/graph/blue.png') }}" alt="" width="16"> : Data Berat Badan 0 - 28 Hari &nbsp;&nbsp;
...
<div class="card">
    <div class="card-header">
        <h5>
            <b>Grafik Tinggi Badan 0 - 2 Tahun</b>
        </h5>
    </div>
    <div class="card-body">
        <table width="100%" style="background-color: white;" border="1">
            <tbody>
                <tr>
                    ...
                    @for ($i = 0; $i < 25; $i++)
                        <td class="text-center" style="background-color: rgb(163, 255, 255);">
                            @for ($x = 0; $x < count($tb28); $x++)
                                @if ($tb28[$x]['neo28_height'] > 90 && $tb28[$x]['neo28_height'] <= 95 && $i == 0)
                                    <img src="{{ asset('data/image/graph/blue.png') }}" alt="" width="16" title="Tgl : {{ $tb28[$x]['neo28_date'] }}, TB : {{ $tb28[$x]['neo28_height'] }} cm">
                                @endif
                            @endfor

                            @for ($y = 0; $y < count($tb02); $y++)
                                @if (date('Y-m', strtotime($tb02[$y]['neobb_date'])) == date('Y-m', strtotime($pas[0]['pat_dob'] . "+" . $i . " months")) && $tb02[$y]['neobb_nut_height'] >= 95)
                                    <img src="{{ asset('data/image/graph/green.png') }}" alt="" width="16" title="Tgl : {{ $tb02[$y]['neobb_date'] }}, TB : {{ $tb02[$y]['neobb_nut_height'] }} cm">
                                @endif
                            @endfor
                        </td>
                    @endfor
                ...
                <tr>
                    ...
                    @for ($i = 0; $i < 25; $i++)
                        <td class="text-center" style="background-color: rgb(163, 255, 255);">
                            @for ($x = 0; $x < count($tb28); $x++)
                                @if ($tb28[$x]['neo28_height'] >= 90 && $tb28[$x]['neo28_height'] < 95 && $i == 0)
                                    <img src="{{ asset('data/image/graph/green.png') }}" alt="" width="16" title="Tgl : {{ $tb28[$x]['neo28_date'] }}, TB : {{ $tb28[$x]['neo28_height'] }} cm">
                                @endif
                            @endfor

                            @for ($y = 0; $y < count($tb02); $y++)
                                @if (date('Y-m', strtotime($tb02[$y]['neobb_date'])) == date('Y-m', strtotime($pas[0]['pat_dob'] . "+" . $i . " months")) && $tb02[$y]['neobb_nut_height'] >= 90 && $tb02[$y]['neobb_nut_height'] < 95)
                                    <img src="{{ asset('data/image/graph/green.png') }}" alt="" width="16" title="Tgl : {{ $tb02[$y]['neobb_date'] }}, TB : {{ $tb02[$y]['neobb_nut_height'] }} cm">
                                @endif
                            @endfor
                        </td>
                ...
                <tr>
                    ...
                    @for ($i = 0; $i < 25; $i++)
                        <td class="text-center" style="background-color: rgb(163, 255, 255);">
                            ...
                            @for ($x = 0; $x < count($tb28); $x++)
                                @if ($tb28[$x]['neo28_height'] >= 85 && $tb28[$x]['neo28_height'] < 90 && $i == 0)
                                    <img src="{{ asset('data/image/graph/green.png') }}" alt="" width="16" title="Tgl : {{ $tb28[$x]['neo28_date'] }}, TB : {{ $tb28[$x]['neo28_height'] }} cm">
                                @endif
                            @endfor

                            @for ($y = 0; $y < count($tb02); $y++)
                                @if (date('Y-m', strtotime($tb02[$y]['neobb_date'])) == date('Y-m', strtotime($pas[0]['pat_dob'] . "+" . $i . " months")) && $tb02[$y]['neobb_nut_height'] >= 85 && $tb02[$y]['neobb_nut_height'] < 90)
                                    <img src="{{ asset('data/image/graph/green.png') }}" alt="" width="16" title="Tgl : {{ $tb02[$y]['neobb_date'] }}, TB : {{ $tb02[$y]['neobb_nut_height'] }} cm">
                                @endif
                            @endfor
                        </td>
                ...
                <tr>
                    ...
                    @for ($i = 0; $i < 25; $i++)
                        <td class="text-center" style="background-color: rgb(163, 255, 255);">
                            ...
                            @for ($x = 0; $x < count($tb28); $x++)
                                @if ($tb28[$x]['neo28_height'] >= 80 && $tb28[$x]['neo28_height'] < 85 && $i == 0)
                                    <img src="{{ asset('data/image/graph/blue.png') }}" alt="" width="16" title="Tgl : {{ $tb28[$x]['neo28_date'] }}, TB : {{ $tb28[$x]['neo28_height'] }} cm">
                                @endif
                            @endfor

                            @for ($y = 0; $y < count($tb02); $y++)
                                @if (date('Y-m', strtotime($tb02[$y]['neobb_date'])) == date('Y-m', strtotime($pas[0]['pat_dob'] . "+" . $i . " months")) && $tb02[$y]['neobb_nut_height'] >= 80 && $tb02[$y]['neobb_nut_height'] < 85)
                                    <img src="{{ asset('data/image/graph/green.png') }}" alt="" width="16" title="Tgl : {{ $tb02[$y]['neobb_date'] }}, TB : {{ $tb02[$y]['neobb_nut_height'] }} cm">
                                @endif
                            @endfor
                        </td>
                ...
                <tr>
                    ...
                    @for ($i = 0; $i < 25; $i++)
                        <td class="text-center" style="background-color: rgb(163, 255, 255);">
                            ...
                            @for ($x = 0; $x < count($tb28); $x++)
                                @if ($tb28[$x]['neo28_height'] >= 75 && $tb28[$x]['neo28_height'] < 80 && $i == 0)
                                    <img src="{{ asset('data/image/graph/blue.png') }}" alt="" width="16" title="Tgl : {{ $tb28[$x]['neo28_date'] }}, TB : {{ $tb28[$x]['neo28_height'] }} cm">
                                @endif
                            @endfor

                            @for ($y = 0; $y < count($tb02); $y++)
                                @if (date('Y-m', strtotime($tb02[$y]['neobb_date'])) == date('Y-m', strtotime($pas[0]['pat_dob'] . "+" . $i . " months")) && $tb02[$y]['neobb_nut_height'] >= 75 && $tb02[$y]['neobb_nut_height'] < 80)
                                    <img src="{{ asset('data/image/graph/green.png') }}" alt="" width="16" title="Tgl : {{ $tb02[$y]['neobb_date'] }}, TB : {{ $tb02[$y]['neobb_nut_height'] }} cm">
                                @endif
                            @endfor
                        </td>
                ...
                <tr>
                    ...
                    @for ($i = 0; $i < 25; $i++)
                        <td class="text-center" style="background-color: rgb(163, 255, 255);">
                            ...
                            @for ($x = 0; $x < count($tb28); $x++)
                                @if ($tb28[$x]['neo28_height'] >= 70 && $tb28[$x]['neo28_height'] < 75 && $i == 0)
                                    <img src="{{ asset('data/image/graph/blue.png') }}" alt="" width="16" title="Tgl : {{ $tb28[$x]['neo28_date'] }}, TB : {{ $tb28[$x]['neo28_height'] }} cm">
                                @endif
                            @endfor

                            @for ($y = 0; $y < count($tb02); $y++)
                                @if (date('Y-m', strtotime($tb02[$y]['neobb_date'])) == date('Y-m', strtotime($pas[0]['pat_dob'] . "+" . $i . " months")) && $tb02[$y]['neobb_nut_height'] >= 70 && $tb02[$y]['neobb_nut_height'] < 75)
                                    <img src="{{ asset('data/image/graph/green.png') }}" alt="" width="16" title="Tgl : {{ $tb02[$y]['neobb_date'] }}, TB : {{ $tb02[$y]['neobb_nut_height'] }} cm">
                                @endif
                            @endfor
                        </td>
                ...
                <tr>
                    ...
                    @for ($i = 0; $i < 25; $i++)
                        <td class="text-center" style="background-color: rgb(163, 255, 255);">
                            ...
                            @for ($x = 0; $x < count($tb28); $x++)
                                @if ($tb28[$x]['neo28_height'] >= 65 && $tb28[$x]['neo28_height'] < 70 && $i == 0)
                                    <img src="{{ asset('data/image/graph/blue.png') }}" alt="" width="16" title="Tgl : {{ $tb28[$x]['neo28_date'] }}, TB : {{ $tb28[$x]['neo28_height'] }} cm">
                                @endif
                            @endfor

                            @for ($y = 0; $y < count($tb02); $y++)
                                @if (date('Y-m', strtotime($tb02[$y]['neobb_date'])) == date('Y-m', strtotime($pas[0]['pat_dob'] . "+" . $i . " months")) && $tb02[$y]['neobb_nut_height'] >= 65 && $tb02[$y]['neobb_nut_height'] < 70)
                                    <img src="{{ asset('data/image/graph/green.png') }}" alt="" width="16" title="Tgl : {{ $tb02[$y]['neobb_date'] }}, TB : {{ $tb02[$y]['neobb_nut_height'] }} cm">
                                @endif
                            @endfor
                        </td>
                ...
                <tr>
                    ...
                    @for ($i = 0; $i < 25; $i++)
                        <td class="text-center" style="background-color: rgb(163, 255, 255);">
                            ...
                            @for ($x = 0; $x < count($tb28); $x++)
                                @if ($tb28[$x]['neo28_height'] >= 60 && $tb28[$x]['neo28_height'] < 65 && $i == 0)
                                    <img src="{{ asset('data/image/graph/blue.png') }}" alt="" width="16" title="Tgl : {{ $tb28[$x]['neo28_date'] }}, TB : {{ $tb28[$x]['neo28_height'] }} cm">
                                @endif
                            @endfor

                            @for ($y = 0; $y < count($tb02); $y++)
                                @if (date('Y-m', strtotime($tb02[$y]['neobb_date'])) == date('Y-m', strtotime($pas[0]['pat_dob'] . "+" . $i . " months")) && $tb02[$y]['neobb_nut_height'] >= 60 && $tb02[$y]['neobb_nut_height'] < 65)
                                    <img src="{{ asset('data/image/graph/green.png') }}" alt="" width="16" title="Tgl : {{ $tb02[$y]['neobb_date'] }}, TB : {{ $tb02[$y]['neobb_nut_height'] }} cm">
                                @endif
                            @endfor
                        </td>
                ...
                <tr>
                    ...
                    @for ($i = 0; $i < 25; $i++)
                        <td class="text-center" style="background-color: rgb(163, 255, 255);">
                            ...
                            @for ($x = 0; $x < count($tb28); $x++)
                                @if ($tb28[$x]['neo28_height'] >= 55 && $tb28[$x]['neo28_height'] < 60 && $i == 0)
                                    <img src="{{ asset('data/image/graph/blue.png') }}" alt="" width="16" title="Tgl : {{ $tb28[$x]['neo28_date'] }}, TB : {{ $tb28[$x]['neo28_height'] }} cm">
                                @endif
                            @endfor

                            @for ($y = 0; $y < count($tb02); $y++)
                                @if (date('Y-m', strtotime($tb02[$y]['neobb_date'])) == date('Y-m', strtotime($pas[0]['pat_dob'] . "+" . $i . " months")) && $tb02[$y]['neobb_nut_height'] >= 55 && $tb02[$y]['neobb_nut_height'] < 60)
                                    <img src="{{ asset('data/image/graph/green.png') }}" alt="" width="16" title="Tgl : {{ $tb02[$y]['neobb_date'] }}, TB : {{ $tb02[$y]['neobb_nut_height'] }} cm">
                                @endif
                            @endfor
                        </td>
                ...
                <tr>
                    ...
                    @for ($i = 0; $i < 25; $i++)
                        <td class="text-center" style="background-color: rgb(163, 255, 255);">
                            ...
                            @for ($x = 0; $x < count($tb28); $x++)
                                @if ($tb28[$x]['neo28_height'] >= 50 && $tb28[$x]['neo28_height'] < 55 && $i == 0)
                                    <img src="{{ asset('data/image/graph/blue.png') }}" alt="" width="16" title="Tgl : {{ $tb28[$x]['neo28_date'] }}, TB : {{ $tb28[$x]['neo28_height'] }} cm">
                                @endif
                            @endfor

                            @for ($y = 0; $y < count($tb02); $y++)
                                @if (date('Y-m', strtotime($tb02[$y]['neobb_date'])) == date('Y-m', strtotime($pas[0]['pat_dob'] . "+" . $i . " months")) && $tb02[$y]['neobb_nut_height'] >= 50 && $tb02[$y]['neobb_nut_height'] < 55)
                                    <img src="{{ asset('data/image/graph/green.png') }}" alt="" width="16" title="Tgl : {{ $tb02[$y]['neobb_date'] }}, TB : {{ $tb02[$y]['neobb_nut_height'] }} cm">
                                @endif
                            @endfor
                        </td>
                ...
                <tr>
                    ...
                    @for ($i = 0; $i < 25; $i++)
                        <td class="text-center" style="background-color: rgb(163, 255, 255);">
                            ...
                            @for ($x = 0; $x < count($tb28); $x++)
                                @if ($tb28[$x]['neo28_height'] <= 45 && $i == 0)
                                    <img src="{{ asset('data/image/graph/blue.png') }}" alt="" width="16" title="Tgl : {{ $tb28[$x]['neo28_date'] }}, TB : {{ $tb28[$x]['neo28_height'] }} cm">
                                @endif
                            @endfor

                            @for ($y = 0; $y < count($tb02); $y++)
                                @if (date('Y-m', strtotime($tb02[$y]['neobb_date'])) == date('Y-m', strtotime($pas[0]['pat_dob'] . "+" . $i . " months")) && $tb02[$y]['neobb_nut_height'] <= 50)
                                    <img src="{{ asset('data/image/graph/green.png') }}" alt="" width="16" title="Tgl : {{ $tb02[$y]['neobb_date'] }}, TB : {{ $tb02[$y]['neobb_nut_height'] }} cm">
                                @endif
                            @endfor
                        </td>
...
<div class="card">
    <div class="card-header">
        <h5>
            <b>Grafik Berat Badan 2 - 20 Tahun</b>
        </h5>
    </div>
    <div class="card-body">
        <table width="100%" style="background-color: white;" border="1">
            <tbody>
                <tr>
                    <td class="rotate text-center" rowspan="20" style="font-size: 18pt; font-weight:bold;" >Berat Badan (Kg)</td>
                    <td class="text-center" width="3%" style="background-color: pink">105</td>
                    @for ($i = 2; $i < 21; $i++)
                        <td class="text-center" style="background-color: rgb(163, 255, 255);">
                            @for ($y = 0; $y < count($tb); $y++)
                                @if ($tb[$y]['neobb_y'] == $i && floor($tb[$y]['neobb_nut_weight']/1000) >= 105)
                                    <img src="{{ asset('data/image/graph/green.png') }}" alt="" width="16" title="Tgl : {{ $tb[$y]['neobb_date'] }}, BB : {{ $tb[$y]['neobb_nut_weight']/1000 }} Kg">
                                @endif
                            @endfor
                        </td>
                    @endfor
                ...
                <tr>
                    ...
                    @for ($i = 2; $i < 21; $i++)
                        <td class="text-center" style="background-color: rgb(163, 255, 255);">
                            @for ($y = 0; $y < count($tb); $y++)
                                @if ($tb[$y]['neobb_y'] == $i && floor($tb[$y]['neobb_nut_weight']/1000) >= 100 && floor($tb[$y]['neobb_nut_weight']/1000) < 105)
                                    <img src="{{ asset('data/image/graph/green.png') }}" alt="" width="16" title="Tgl : {{ $tb[$y]['neobb_date'] }}, BB : {{ $tb[$y]['neobb_nut_weight']/1000 }} Kg">
                                @endif
                            @endfor
                        </td>
                ...
                <tr>
                    ...
                    @for ($i = 2; $i < 21; $i++)
                        <td class="text-center" style="background-color: rgb(163, 255, 255);">
                            @for ($y = 0; $y < count($tb); $y++)
                                @if ($tb[$y]['neobb_y'] == $i && floor($tb[$y]['neobb_nut_weight']/1000) >= 90 && floor($tb[$y]['neobb_nut_weight']/1000) < 100)
                                    <img src="{{ asset('data/image/graph/green.png') }}" alt="" width="16" title="Tgl : {{ $tb[$y]['neobb_date'] }}, BB : {{ $tb[$y]['neobb_nut_weight']/1000 }} Kg">
                                @endif
                            @endfor
                        </td>
                ...
                <tr>
                    ...
                    @for ($i = 2; $i < 21; $i++)
                        <td class="text-center" style="background-color: rgb(163, 255, 255);">
                            @for ($y = 0; $y < count($tb); $y++)
                                @if ($tb[$y]['neobb_y'] == $i && floor($tb[$y]['neobb_nut_weight']/1000) >= 90 && floor($tb[$y]['neobb_nut_weight']/1000) < 95)
                                    <img src="{{ asset('data/image/graph/green.png') }}" alt="" width="16" title="Tgl : {{ $tb[$y]['neobb_date'] }}, BB : {{ $tb[$y]['neobb_nut_weight']/1000 }} Kg">
                                @endif
                            @endfor
                        </td>
                ...
                <tr>
                    ...
                    @for ($i = 2; $i < 21; $i++)
                        <td class="text-center" style="background-color: rgb(163, 255, 255);">
                            @for ($y = 0; $y < count($tb); $y++)
                                @if ($tb[$y]['neobb_y'] == $i && floor($tb[$y]['neobb_nut_weight']/1000) >= 85 && floor($tb[$y]['neobb_nut_weight']/1000) < 90)
                                    <img src="{{ asset('data/image/graph/green.png') }}" alt="" width="16" title="Tgl : {{ $tb[$y]['neobb_date'] }}, BB : {{ $tb[$y]['neobb_nut_weight']/1000 }} Kg">
                                @endif
                            @endfor
                        </td>
                ...
                <tr>
                    ...
                    @for ($i = 2; $i < 21; $i++)
                        <td class="text-center" style="background-color: rgb(163, 255, 255);">
                            @for ($y = 0; $y < count($tb); $y++)
                                @if ($tb[$y]['neobb_y'] == $i && floor($tb[$y]['neobb_nut_weight']/1000) >= 80 && floor($tb[$y]['neobb_nut_weight']/1000) < 85)
                                    <img src="{{ asset('data/image/graph/green.png') }}" alt="" width="16" title="Tgl : {{ $tb[$y]['neobb_date'] }}, BB : {{ $tb[$y]['neobb_nut_weight']/1000 }} Kg">
                                @endif
                            @endfor
                        </td>
                ...
                <tr>
                    ...
                    @for ($i = 2; $i < 21; $i++)
                        <td class="text-center" style="background-color: rgb(163, 255, 255);">
                            @for ($y = 0; $y < count($tb); $y++)
                                @if ($tb[$y]['neobb_y'] == $i && floor($tb[$y]['neobb_nut_weight']/1000) >= 75 && floor($tb[$y]['neobb_nut_weight']/1000) < 80)
                                    <img src="{{ asset('data/image/graph/green.png') }}" alt="" width="16" title="Tgl : {{ $tb[$y]['neobb_date'] }}, BB : {{ $tb[$y]['neobb_nut_weight']/1000 }} Kg">
                                @endif
                            @endfor
                        </td>
                ...
                <tr>
                    ...
                    @for ($i = 2; $i < 21; $i++)
                        <td class="text-center" style="background-color: rgb(163, 255, 255);">
                            ...
                            @for ($y = 0; $y < count($tb); $y++)
                                @if ($tb[$y]['neobb_y'] == $i && floor($tb[$y]['neobb_nut_weight']/1000) >= 70 && floor($tb[$y]['neobb_nut_weight']/1000) < 75)
                                    <img src="{{ asset('data/image/graph/green.png') }}" alt="" width="16" title="Tgl : {{ $tb[$y]['neobb_date'] }}, BB : {{ $tb[$y]['neobb_nut_weight']/1000 }} Kg">
                                @endif
                            @endfor
                        </td>
                ...
                <tr>
                    ...
                    @for ($i = 2; $i < 21; $i++)
                        <td class="text-center" style="background-color: rgb(163, 255, 255);">
                            ...
                            @for ($y = 0; $y < count($tb); $y++)
                                @if ($tb[$y]['neobb_y'] == $i && floor($tb[$y]['neobb_nut_weight']/1000) >= 65 && floor($tb[$y]['neobb_nut_weight']/1000) < 70)
                                    <img src="{{ asset('data/image/graph/green.png') }}" alt="" width="16" title="Tgl : {{ $tb[$y]['neobb_date'] }}, BB : {{ $tb[$y]['neobb_nut_weight']/1000 }} Kg">
                                @endif
                            @endfor
                        </td>
                ...
                <tr>
                    ...
                    @for ($i = 2; $i < 21; $i++)
                        <td class="text-center" style="background-color: rgb(163, 255, 255);">
                            ...
                            @for ($y = 0; $y < count($tb); $y++)
                                @if ($tb[$y]['neobb_y'] == $i && floor($tb[$y]['neobb_nut_weight']/1000) >= 60 && floor($tb[$y]['neobb_nut_weight']/1000) < 65)
                                    <img src="{{ asset('data/image/graph/green.png') }}" alt="" width="16" title="Tgl : {{ $tb[$y]['neobb_date'] }}, BB : {{ $tb[$y]['neobb_nut_weight']/1000 }} Kg">
                                @endif
                            @endfor
                        </td>
                ...
                <tr>
                    ...
                    @for ($i = 2; $i < 21; $i++)
                        <td class="text-center" style="background-color: rgb(163, 255, 255);">
                            ...
                            @for ($y = 0; $y < count($tb); $y++)
                                @if ($tb[$y]['neobb_y'] == $i && floor($tb[$y]['neobb_nut_weight']/1000) >= 55 && floor($tb[$y]['neobb_nut_weight']/1000) < 60)
                                    <img src="{{ asset('data/image/graph/green.png') }}" alt="" width="16" title="Tgl : {{ $tb[$y]['neobb_date'] }}, BB : {{ $tb[$y]['neobb_nut_weight']/1000 }} Kg">
                                @endif
                            @endfor
                        </td>
                ...
                <tr>
                    ...
                    @for ($i = 2; $i < 21; $i++)
                        <td class="text-center" style="background-color: rgb(163, 255, 255);">
                            ...
                            @for ($y = 0; $y < count($tb); $y++)
                                @if ($tb[$y]['neobb_y'] == $i && floor($tb[$y]['neobb_nut_weight']/1000) >= 50 && floor($tb[$y]['neobb_nut_weight']/1000) < 55)
                                    <img src="{{ asset('data/image/graph/green.png') }}" alt="" width="16" title="Tgl : {{ $tb[$y]['neobb_date'] }}, BB : {{ $tb[$y]['neobb_nut_weight']/1000 }} Kg">
                                @endif
                            @endfor
                        </td>
                ...
                <tr>
                    ...
                    @for ($i = 2; $i < 21; $i++)
                        <td class="text-center" style="background-color: rgb(163, 255, 255);">
                            ...
                            @for ($y = 0; $y < count($tb); $y++)
                                @if ($tb[$y]['neobb_y'] == $i && floor($tb[$y]['neobb_nut_weight']/1000) >= 45 && floor($tb[$y]['neobb_nut_weight']/1000) < 50)
                                    <img src="{{ asset('data/image/graph/green.png') }}" alt="" width="16" title="Tgl : {{ $tb[$y]['neobb_date'] }}, BB : {{ $tb[$y]['neobb_nut_weight']/1000 }} Kg">
                                @endif
                            @endfor
                        </td>
                ...
                <tr>
                    ...
                    @for ($i = 2; $i < 21; $i++)
                        <td class="text-center" style="background-color: rgb(163, 255, 255);">
                            ...
                            @for ($y = 0; $y < count($tb); $y++)
                                @if ($tb[$y]['neobb_y'] == $i && floor($tb[$y]['neobb_nut_weight']/1000) >= 40 && floor($tb[$y]['neobb_nut_weight']/1000) < 45)
                                    <img src="{{ asset('data/image/graph/green.png') }}" alt="" width="16" title="Tgl : {{ $tb[$y]['neobb_date'] }}, BB : {{ $tb[$y]['neobb_nut_weight']/1000 }} Kg">
                                @endif
                            @endfor
                        </td>
                ...
                <tr>
                    ...
                    @for ($i = 2; $i < 21; $i++)
                        <td class="text-center" style="background-color: rgb(163, 255, 255);">
                            ...
                            @for ($y = 0; $y < count($tb); $y++)
                                @if ($tb[$y]['neobb_y'] == $i && floor($tb[$y]['neobb_nut_weight']/1000) >= 35 && floor($tb[$y]['neobb_nut_weight']/1000) < 40)
                                    <img src="{{ asset('data/image/graph/green.png') }}" alt="" width="16" title="Tgl : {{ $tb[$y]['neobb_date'] }}, BB : {{ $tb[$y]['neobb_nut_weight']/1000 }} Kg">
                                @endif
                            @endfor
                        </td>
                ...
                <tr>
                    ...
                    @for ($i = 2; $i < 21; $i++)
                        <td class="text-center" style="background-color: rgb(163, 255, 255);">
                            ...
                            @for ($y = 0; $y < count($tb); $y++)
                                @if ($tb[$y]['neobb_y'] == $i && floor($tb[$y]['neobb_nut_weight']/1000) >= 30 && floor($tb[$y]['neobb_nut_weight']/1000) < 35)
                                    <img src="{{ asset('data/image/graph/green.png') }}" alt="" width="16" title="Tgl : {{ $tb[$y]['neobb_date'] }}, BB : {{ $tb[$y]['neobb_nut_weight']/1000 }} Kg">
                                @endif
                            @endfor
                        </td>
                ...
                <tr>
                    ...
                    @for ($i = 2; $i < 21; $i++)
                        <td class="text-center" style="background-color: rgb(163, 255, 255);">
                            ...
                            @for ($y = 0; $y < count($tb); $y++)
                                @if ($tb[$y]['neobb_y'] == $i && floor($tb[$y]['neobb_nut_weight']/1000) >= 25 && floor($tb[$y]['neobb_nut_weight']/1000) < 30)
                                    <img src="{{ asset('data/image/graph/green.png') }}" alt="" width="16" title="Tgl : {{ $tb[$y]['neobb_date'] }}, BB : {{ $tb[$y]['neobb_nut_weight']/1000 }} Kg">
                                @endif
                            @endfor
                        </td>
                ...
                <tr>
                    ...
                    @for ($i = 2; $i < 21; $i++)
                        <td class="text-center" style="background-color: rgb(163, 255, 255);">
                            ...
                            @for ($y = 0; $y < count($tb); $y++)
                                @if ($tb[$y]['neobb_y'] == $i && floor($tb[$y]['neobb_nut_weight']/1000) >= 20 && floor($tb[$y]['neobb_nut_weight']/1000) < 25)
                                    <img src="{{ asset('data/image/graph/green.png') }}" alt="" width="16" title="Tgl : {{ $tb[$y]['neobb_date'] }}, BB : {{ $tb[$y]['neobb_nut_weight']/1000 }} Kg">
                                @endif
                            @endfor
                        </td>
                ...
                <tr>
                    ...
                    @for ($i = 2; $i < 21; $i++)
                        <td class="text-center" style="background-color: rgb(163, 255, 255);">
                            ...
                            @for ($y = 0; $y < count($tb); $y++)
                                @if ($tb[$y]['neobb_y'] == $i && floor($tb[$y]['neobb_nut_weight']/1000) >= 15 && floor($tb[$y]['neobb_nut_weight']/1000) < 20)
                                    <img src="{{ asset('data/image/graph/green.png') }}" alt="" width="16" title="Tgl : {{ $tb[$y]['neobb_date'] }}, BB : {{ $tb[$y]['neobb_nut_weight']/1000 }} Kg">
                                @endif
                            @endfor
                        </td>
                ...
                <tr>
                    ...
                    @for ($i = 2; $i < 21; $i++)
                        <td class="text-center" style="background-color: rgb(163, 255, 255);">
                            ...
                            @for ($y = 0; $y < count($tb); $y++)
                                @if ($tb[$y]['neobb_y'] == $i && floor($tb[$y]['neobb_nut_weight']/1000) < 15)
                                    <img src="{{ asset('data/image/graph/green.png') }}" alt="" width="16" title="Tgl : {{ $tb[$y]['neobb_date'] }}, BB : {{ $tb[$y]['neobb_nut_weight']/1000 }} Kg">
                                @endif
                            @endfor
                        </td>
                ...
                <tr>
                    <td class="text-right" colspan="2" style="background-color: rgb(255, 211, 130)"><b>Umur (Tahun)</b></td>
                    @for ($i = 2; $i < 21; $i++)
                        <td class="text-center" width="4.5%" style="background-color: rgb(255, 211, 130)"><b>{{ $i }}</b></td>
                    @endfor
                </tr>
            </tbody>
        </table>
...
<div class="card">
    <div class="card-header">
        <h5>
            <b>Grafik Tinggi Badan 2 - 20 Tahun</b>
        </h5>
    </div>
    <div class="card-body">
        <table width="100%" style="background-color: white;" border="1">
            <tbody>
                <tr>
                    <td class="rotate text-center" rowspan="23" style="font-size: 18pt; font-weight:bold;" >Tinggi Badan (cm)</td>
                    <td class="text-center" width="3%" style="background-color: pink">190</td>
                    @for ($i = 2; $i < 21; $i++)
                        <td class="text-center" style="background-color: rgb(163, 255, 255);">
                            @for ($y = 0; $y < count($tb); $y++)
                                @if ($tb[$y]['neobb_y'] == $i && floor($tb[$y]['neobb_nut_height']/1000) > 190)
                                    <img src="{{ asset('data/image/graph/green.png') }}" alt="" width="16" title="Tgl : {{ $tb[$y]['neobb_date'] }}, TB : {{ $tb[$y]['neobb_nut_height'] }} cm">
                                @endif
                            @endfor
                        </td>
                    @endfor
                ...
                <tr>
                    ...
                    @for ($i = 2; $i < 21; $i++)
                        <td class="text-center" style="background-color: rgb(163, 255, 255);">
                            @for ($y = 0; $y < count($tb); $y++)
                                @if ($tb[$y]['neobb_y'] == $i && floor($tb[$y]['neobb_nut_height']/1000) >= 185 && floor($tb[$y]['neobb_nut_height']/1000) < 190)
                                    <img src="{{ asset('data/image/graph/green.png') }}" alt="" width="16" title="Tgl : {{ $tb[$y]['neobb_date'] }}, TB : {{ $tb[$y]['neobb_nut_height'] }} cm">
                                @endif
                            @endfor
                        </td>
                ...
                <tr>
                    ...
                    @for ($i = 2; $i < 21; $i++)
                        <td class="text-center" style="background-color: rgb(163, 255, 255);">
                            @for ($y = 0; $y < count($tb); $y++)
                                @if ($tb[$y]['neobb_y'] == $i && floor($tb[$y]['neobb_nut_height']/1000) >= 180 && floor($tb[$y]['neobb_nut_height']/1000) < 185)
                                    <img src="{{ asset('data/image/graph/green.png') }}" alt="" width="16" title="Tgl : {{ $tb[$y]['neobb_date'] }}, TB : {{ $tb[$y]['neobb_nut_height'] }} cm">
                                @endif
                            @endfor
                        </td>
                ...
                <tr>
                    ...
                    @for ($i = 2; $i < 21; $i++)
                        <td class="text-center" style="background-color: rgb(163, 255, 255);">
                            ...
                            @for ($y = 0; $y < count($tb); $y++)
                                @if ($tb[$y]['neobb_y'] == $i && floor($tb[$y]['neobb_nut_height']/1000) >= 175 && floor($tb[$y]['neobb_nut_height']/1000) < 180)
                                    <img src="{{ asset('data/image/graph/green.png') }}" alt="" width="16" title="Tgl : {{ $tb[$y]['neobb_date'] }}, TB : {{ $tb[$y]['neobb_nut_height'] }} cm">
                                @endif
                            @endfor
                        </td>
                ...
                <tr>
                    ...
                    @for ($i = 2; $i < 21; $i++)
                        <td class="text-center" style="background-color: rgb(163, 255, 255);">
                            ...
                            @for ($y = 0; $y < count($tb); $y++)
                                @if ($tb[$y]['neobb_y'] == $i && floor($tb[$y]['neobb_nut_height']/1000) >= 170 && floor($tb[$y]['neobb_nut_height']/1000) < 175)
                                    <img src="{{ asset('data/image/graph/green.png') }}" alt="" width="16" title="Tgl : {{ $tb[$y]['neobb_date'] }}, TB : {{ $tb[$y]['neobb_nut_height'] }} cm">
                                @endif
                            @endfor
                        </td>
                ...
                <tr>
                    ...
                    @for ($i = 2; $i < 21; $i++)
                        <td class="text-center" style="background-color: rgb(163, 255, 255);">
                            @for ($y = 0; $y < count($tb); $y++)
                                @if ($tb[$y]['neobb_y'] == $i && floor($tb[$y]['neobb_nut_height']/1000) >= 165 && floor($tb[$y]['neobb_nut_height']/1000) < 170)
                                    <img src="{{ asset('data/image/graph/green.png') }}" alt="" width="16" title="Tgl : {{ $tb[$y]['neobb_date'] }}, TB : {{ $tb[$y]['neobb_nut_height'] }} cm">
                                @endif
                            @endfor
                        </td>
                ...
                <tr>
                    ...
                    @for ($i = 2; $i < 21; $i++)
                        <td class="text-center" style="background-color: rgb(163, 255, 255);">
                            ...
                            @for ($y = 0; $y < count($tb); $y++)
                                @if ($tb[$y]['neobb_y'] == $i && floor($tb[$y]['neobb_nut_height']/1000) >= 160 && floor($tb[$y]['neobb_nut_height']/1000) < 165)
                                    <img src="{{ asset('data/image/graph/green.png') }}" alt="" width="16" title="Tgl : {{ $tb[$y]['neobb_date'] }}, TB : {{ $tb[$y]['neobb_nut_height'] }} cm">
                                @endif
                            @endfor
                        </td>
                ...
                <tr>
                    ...
                    @for ($i = 2; $i < 21; $i++)
                        <td class="text-center" style="background-color: rgb(163, 255, 255);">
                            ...
                            @for ($y = 0; $y < count($tb); $y++)
                                @if ($tb[$y]['neobb_y'] == $i && floor($tb[$y]['neobb_nut_height']/1000) >= 155 && floor($tb[$y]['neobb_nut_height']/1000) < 160)
                                    <img src="{{ asset('data/image/graph/green.png') }}" alt="" width="16" title="Tgl : {{ $tb[$y]['neobb_date'] }}, TB : {{ $tb[$y]['neobb_nut_height'] }} cm">
                                @endif
                            @endfor
                        </td>
                ...
                <tr>
                    ...
                    @for ($i = 2; $i < 21; $i++)
                        <td class="text-center" style="background-color: rgb(163, 255, 255);">
                            ...
                            @for ($y = 0; $y < count($tb); $y++)
                                @if ($tb[$y]['neobb_y'] == $i && floor($tb[$y]['neobb_nut_height']/1000) >= 150 && floor($tb[$y]['neobb_nut_height']/1000) < 155)
                                    <img src="{{ asset('data/image/graph/green.png') }}" alt="" width="16" title="Tgl : {{ $tb[$y]['neobb_date'] }}, TB : {{ $tb[$y]['neobb_nut_height'] }} cm">
                                @endif
                            @endfor
                        </td>
                ...
                <tr>
                    ...
                    @for ($i = 2; $i < 21; $i++)
                        <td class="text-center" style="background-color: rgb(163, 255, 255);">
                            ...
                            @for ($y = 0; $y < count($tb); $y++)
                                @if ($tb[$y]['neobb_y'] == $i && floor($tb[$y]['neobb_nut_height']/1000) >= 145 && floor($tb[$y]['neobb_nut_height']/1000) < 150)
                                    <img src="{{ asset('data/image/graph/green.png') }}" alt="" width="16" title="Tgl : {{ $tb[$y]['neobb_date'] }}, TB : {{ $tb[$y]['neobb_nut_height'] }} cm">
                                @endif
                            @endfor
                        </td>
                ...
                <tr>
                    ...
                    @for ($i = 2; $i < 21; $i++)
                        <td class="text-center" style="background-color: rgb(163, 255, 255);">
                            ...
                            @for ($y = 0; $y < count($tb); $y++)
                                @if ($tb[$y]['neobb_y'] == $i && floor($tb[$y]['neobb_nut_height']/1000) >= 140 && floor($tb[$y]['neobb_nut_height']/1000) < 145)
                                    <img src="{{ asset('data/image/graph/green.png') }}" alt="" width="16" title="Tgl : {{ $tb[$y]['neobb_date'] }}, TB : {{ $tb[$y]['neobb_nut_height'] }} cm">
                                @endif
                            @endfor
                        </td>
                ...
                <tr>
                    ...
                    @for ($i = 2; $i < 21; $i++)
                        <td class="text-center" style="background-color: rgb(163, 255, 255);">
                            ...
                            @for ($y = 0; $y < count($tb); $y++)
                                @if ($tb[$y]['neobb_y'] == $i && floor($tb[$y]['neobb_nut_height']/1000) >= 130 && floor($tb[$y]['neobb_nut_height']/1000) < 135)
                                    <img src="{{ asset('data/image/graph/green.png') }}" alt="" width="16" title="Tgl : {{ $tb[$y]['neobb_date'] }}, TB : {{ $tb[$y]['neobb_nut_height'] }} cm">
                                @endif
                            @endfor
                        </td>
                ...
                <tr>
                    ...
                    @for ($i = 2; $i < 21; $i++)
                        <td class="text-center" style="background-color: rgb(163, 255, 255);">
                            ...
                            @for ($y = 0; $y < count($tb); $y++)
                                @if ($tb[$y]['neobb_y'] == $i && floor($tb[$y]['neobb_nut_height']/1000) >= 110 && floor($tb[$y]['neobb_nut_height']/1000) < 125)
                                    <img src="{{ asset('data/image/graph/green.png') }}" alt="" width="16" title="Tgl : {{ $tb[$y]['neobb_date'] }}, TB : {{ $tb[$y]['neobb_nut_height'] }} cm">
                                @endif
                            @endfor
                        </td>
                ...
                <tr>
                    ...
                    @for ($i = 2; $i < 21; $i++)
                        <td class="text-center" style="background-color: rgb(163, 255, 255);">
                            ...
                            @for ($y = 0; $y < count($tb); $y++)
                                @if ($tb[$y]['neobb_y'] == $i && floor($tb[$y]['neobb_nut_height']/1000) >= 115 && floor($tb[$y]['neobb_nut_height']/1000) < 120)
                                    <img src="{{ asset('data/image/graph/green.png') }}" alt="" width="16" title="Tgl : {{ $tb[$y]['neobb_date'] }}, TB : {{ $tb[$y]['neobb_nut_height'] }} cm">
                                @endif
                            @endfor
                        </td>
                ...
                <tr>
                    ...
                    @for ($i = 2; $i < 21; $i++)
                        <td class="text-center" style="background-color: rgb(163, 255, 255);">
                            @for ($y = 0; $y < count($tb); $y++)
                                @if ($tb[$y]['neobb_y'] == $i && floor($tb[$y]['neobb_nut_height']/1000) >= 110 && floor($tb[$y]['neobb_nut_height']/1000) < 115)
                                    <img src="{{ asset('data/image/graph/green.png') }}" alt="" width="16" title="Tgl : {{ $tb[$y]['neobb_date'] }}, TB : {{ $tb[$y]['neobb_nut_height'] }} cm">
                                @endif
                            @endfor
                        </td>
                ...
                <tr>
                    ...
                    @for ($i = 2; $i < 21; $i++)
                        <td class="text-center" style="background-color: rgb(163, 255, 255);">
                            ...
                            @for ($y = 0; $y < count($tb); $y++)
                                @if ($tb[$y]['neobb_y'] == $i && floor($tb[$y]['neobb_nut_height']/1000) >= 105 && floor($tb[$y]['neobb_nut_height']/1000) < 110)
                                    <img src="{{ asset('data/image/graph/green.png') }}" alt="" width="16" title="Tgl : {{ $tb[$y]['neobb_date'] }}, TB : {{ $tb[$y]['neobb_nut_height'] }} cm">
                                @endif
                            @endfor
                        </td>
                ...
                <tr>
                    ...
                    @for ($i = 2; $i < 21; $i++)
                        <td class="text-center" style="background-color: rgb(163, 255, 255);">
                            ...
                            @for ($y = 0; $y < count($tb); $y++)
                                @if ($tb[$y]['neobb_y'] == $i && floor($tb[$y]['neobb_nut_height']/1000) >= 100 && floor($tb[$y]['neobb_nut_height']/1000) < 105)
                                    <img src="{{ asset('data/image/graph/green.png') }}" alt="" width="16" title="Tgl : {{ $tb[$y]['neobb_date'] }}, TB : {{ $tb[$y]['neobb_nut_height'] }} cm">
                                @endif
                            @endfor
                        </td>
                ...
                <tr>
                    ...
                    @for ($i = 2; $i < 21; $i++)
                        <td class="text-center" style="background-color: rgb(163, 255, 255);">
                            ...
                            @for ($y = 0; $y < count($tb); $y++)
                                @if ($tb[$y]['neobb_y'] == $i && floor($tb[$y]['neobb_nut_height']/1000) >= 95 && floor($tb[$y]['neobb_nut_height']/1000) < 100)
                                    <img src="{{ asset('data/image/graph/green.png') }}" alt="" width="16" title="Tgl : {{ $tb[$y]['neobb_date'] }}, TB : {{ $tb[$y]['neobb_nut_height'] }} cm">
                                @endif
                            @endfor
                        </td>
                ...
                <tr>
                    ...
                    @for ($i = 2; $i < 21; $i++)
                        <td class="text-center" style="background-color: rgb(163, 255, 255);">
                            ...
                            @for ($y = 0; $y < count($tb); $y++)
                                @if ($tb[$y]['neobb_y'] == $i && floor($tb[$y]['neobb_nut_height']/1000) >= 90 && floor($tb[$y]['neobb_nut_height']/1000) < 95)
                                    <img src="{{ asset('data/image/graph/green.png') }}" alt="" width="16" title="Tgl : {{ $tb[$y]['neobb_date'] }}, TB : {{ $tb[$y]['neobb_nut_height'] }} cm">
                                @endif
                            @endfor
                        </td>
                ...
                <tr>
                    ...
                    @for ($i = 2; $i < 21; $i++)
                        <td class="text-center" style="background-color: rgb(163, 255, 255);">
                            ...
                            @for ($y = 0; $y < count($tb); $y++)
                                @if ($tb[$y]['neobb_y'] == $i && floor($tb[$y]['neobb_nut_height']/1000) >= 85 && floor($tb[$y]['neobb_nut_height']/1000) < 90)
                                    <img src="{{ asset('data/image/graph/green.png') }}" alt="" width="16" title="Tgl : {{ $tb[$y]['neobb_date'] }}, TB : {{ $tb[$y]['neobb_nut_height'] }} cm">
                                @endif
                            @endfor
                        </td>
                ...
                <tr>
                    ...
                    @for ($i = 2; $i < 21; $i++)
                        <td class="text-center" style="background-color: rgb(163, 255, 255);">
                            @for ($y = 0; $y < count($tb); $y++)
                                @if ($tb[$y]['neobb_y'] == $i && floor($tb[$y]['neobb_nut_height']/1000) < 85)
                                    <img src="{{ asset('data/image/graph/green.png') }}" alt="" width="16" title="Tgl : {{ $tb[$y]['neobb_date'] }}, TB : {{ $tb[$y]['neobb_nut_height'] }} cm">
                                @endif
                            @endfor
                        </td>
