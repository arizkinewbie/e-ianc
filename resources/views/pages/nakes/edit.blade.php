...
<div class="row justify-content-center">
    <div class="col-md-10">
        <div class="card">
            <form action="{{ route('nakes.update') }}" method="post" autocomplete="off">
                @csrf
                <input type="hidden" name="id" value="{{ $data->nakes_id }}">
                <div class="card-body">
                    <div class="row">
                        <div class="col-md-6">
                            <div class="form-group">
                                ...
                                <input type="text" name="nakes_name" id="nakes_name" class="form-control"
                                    value="{{ (old('nakes_name')) ? old('nakes_name') : $data->nakes_name }}">
                            ...
                            <div class="form-group">
                                ...
                                <input type="text" name="nakes_nip" id="nakes_nip" class="form-control"
                                    value="{{ (old('nakes_nip')) ? old('nakes_nip') : $data->nakes_nip }}">
                            ...
                            <div class="form-group">
                                ...
                                <input type="text" name="nakes_sip" id="nakes_sip" class="form-control"
                                    value="{{ (old('nakes_sip')) ? old('nakes_sip') : $data->nakes_sip }}">
                            ...
                            <div class="form-group">
                                ...
                                <input type="text" name="nakes_sip_date" id="nakes_sip_date" class="form-control datepicker"
                                    value="{{ (old('nakes_sip_date')) ? old('nakes_sip_date') : $data->nakes_sip_date }}" readonly>
                            ...
                            <div class="form-group">
                                ...
                                <input type="text" name="nakes_telp" id="nakes_telp" class="form-control"
                                    value="{{ (old('nakes_telp')) ? old('nakes_telp') : $data->nakes_telp }}" maxlength="15">
                        ...
                        <div class="col-md-5">
                            <div class="form-group">
                                ...
                                <select name="nakes_province" id="nakes_province" class="form-control select2">
                                    ...
                                    <option value="{{ $pro->kode }}" {{ ($pro->kode == old('nakes_province')) ? 'selected' : (($pro->kode == $data->nakes_province) ? 'selected' : '' ) }}>{{ $pro->nama }}</option>
                                    @endforeach
                                </select>
                            </div>
                            <div class="form-group">
                                ...
                                <select name="nakes_district" id="nakes_district" class="form-control select2">
                                    @php
                                        $kab = DB::table('sys_alamats')->where('kode', $data->nakes_district)->get();
                                    @endphp
                            ...
                            <div class="form-group">
                                ...
                                <select name="nakes_subdistrict" id="nakes_subdistrict" class="form-control select2">
                                    @php
                                        $kab = DB::table('sys_alamats')->where('kode', $data->nakes_subdistrict)->get();
                                    @endphp
                                    <option value="{{ $kab[0]->kode }}">{{ $kab[0]->nama }}</option>
                                </select>
                            </div>
                            <div class="form-group">
                                ...
                                <select name="nakes_village" id="nakes_village" class="form-control select2">
                                    @php
                                        $kab = DB::table('sys_alamats')->where('kode', $data->nakes_village)->get();
                                    @endphp
                                    <option value="{{ $kab[0]->kode }}">{{ $kab[0]->nama }}</option>
                                </select>
                            </div>
                                ...
                                <div class="row">
                                    <div class="col-md-6">
                                        ...
                                        <select name="nakes_rw" id="nakes_rw" class="form-control select2">
                                            ...
                                            @for ($i = 1; $i < 100; $i++)
                                                <option value="{{ sprintf("%03s", ($i)) }}" {{ (sprintf("%03s", ($i)) == old('rw')) ? 'selected' : ((sprintf("%03s", ($i)) == $data->nakes_rw) ? 'selected' : '') }}>{{ sprintf("%03s", ($i)) }}</option>
                                            @endfor
                                        </select>
                                    ...
                                    <div class="col-md-6">
                                        ...
                                        <select name="nakes_rt" id="nakes_rt" class="form-control select2">
                                            ...
                                            @for ($i = 1; $i < 100; $i++)
                                                <option value="{{ sprintf("%03s", ($i)) }}" {{ (sprintf("%03s", ($i)) == old('rw')) ? 'selected' : ((sprintf("%03s", ($i)) == $data->nakes_rt) ? 'selected' : '') }}>{{ sprintf("%03s", ($i)) }}</option>
                                            @endfor
                                        </select>
                            ...
                            <div class="form-group">
                                ...
                                <textarea name="nakes_address" id="nakes_address" cols="30" rows="3"
                                    class="form-control">{{ (old('nakes_address')) ? old('nakes_address') : $data->nakes_address }}</textarea>
                            ...
                            <div class="form-group">
                                <div class="row">
                                    ...
                                    <div class="col-md-8">
                                        <input type="text" name="nakes_zip_code" id="nakes_zip_code" class="form-control text-center" value="{{ (old('nakes_zip_code')) ? old('nakes_zip_code') : $data->nakes_zip_code }}">
                                    </div>
                                </div>
                            </div>
                            <div class="form-group">
                                <label for="nakes_status">Status</label>
                                <select name="nakes_status" id="nakes_status" class="form-control">
                                    <option value="0" {{ ($data->nakes_status == '0') ? 'selected' : '' }}>Blocked</option>
                                    <option value="1" {{ ($data->nakes_status == '1') ? 'selected' : '' }}>Active</option>
                                </select>
                            </div>
                        </div>
                    </div>
