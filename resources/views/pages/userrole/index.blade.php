            ...
            <tbody>
                @foreach ($data as $d)
                    <tr>
                        ...
                        <td class="text-center">
                            <a href="{{ route('userrole.edit', Crypt::encrypt($d->user_role_id)) }}">
                                <button class="btn btn-sm btn-warning" title="edit">
                                    <i class="fa fa-edit"></i>
                                </button>
                            </a>
                            &nbsp;|&nbsp;
                            <form action="{{ route('userrole.destroy') }}" method="post" class="d-inline">
                                @csrf
                                <input type="hidden" name="id" value="{{ Crypt::encrypt($d->user_role_code) }}">
