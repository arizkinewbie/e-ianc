    ...
    <table style="width: 100%; border-collapse: collapse; font-size: 10pt; margin-top: 20px;">
        <thead style=" border: 1px solid black;">
            <tr style=" border: 1px solid black;">
                ...
                @foreach ($dest as $d)
                    <th style=" border: 1px solid black;">{{ strtoupper(DB::table('sys_alamats')->where('kode', $d->ds_destination)->value('nama')) }}</th>
                @endforeach
                ...
                @foreach ($dest as $d)
                    <td style=" border: 1px solid black; text-align: center;">
                        <?php
                            ...
                            foreach ($kie as $a) {
                                if ($a->ins_village == $d->ds_destination && $a->sanckie_kia_book == '1') {
                    ...
                    <td style=" border: 1px solid black; text-align: center;">
                        <?php
                            ...
                            foreach ($anamnesa as $a) {
                                if ($a->ins_village == $d->ds_destination && $a->sanca_trimester == 'I' && date('Y-m', strtotime($a->sancd_date)) == date('Y-m', strtotime($year . '-' . $month))) {
                            ...
                            foreach ($anamnesa as $a) {
                                if ($a->ins_village == $d->ds_destination && $a->sanca_trimester != 'I' && $a->sancd_no == '1' && date('Y-m', strtotime($a->sancd_date)) == date('Y-m', strtotime($year . '-' . $month))) {
                ...
                @foreach ($dest as $d)
                    <td style=" border: 1px solid black; text-align: center;">
                        <?php
                            ...
                            foreach ($anamnesa as $a) {
                                if ($a->ins_village == $d->ds_destination && $a->sancd_no == '4' && date('Y-m', strtotime($a->sancd_date)) == date('Y-m', strtotime($year . '-' . $month))) {
                ...
                @foreach ($dest as $d)
                    <td style=" border: 1px solid black; text-align: center;">
                        <?php
                            ...
                            foreach ($lab as $a) {
                                if (($a->ins_village == $d->ds_destination && $a->sancl_bta == 1 && date('Y-m', strtotime($a->sancd_date)) == date('Y-m', strtotime($year . '-' . $month))) || ($a->ins_village == $d->ds_destination && $a->sancl_bta == 2 && date('Y-m', strtotime($a->sancd_date)) == date('Y-m', strtotime($year . '-' . $month)))) {
                ...
                @foreach ($dest as $d)
                    <td style=" border: 1px solid black; text-align: center;">
                        <?php
                            ...
                            foreach ($lab as $a) {
                                if (($a->ins_village == $d->ds_destination && $a->sancl_bta == 2 && date('Y-m', strtotime($a->sancd_date)) == date('Y-m', strtotime($year . '-' . $month)))) {
                ...
                @foreach ($dest as $d)
                    <td style=" border: 1px solid black; text-align: center;">
                        <?php
                            ...
                            foreach ($lab as $a) {
                                if (($a->ins_village == $d->ds_destination && $a->sancl_sifilis == 1 && date('Y-m', strtotime($a->sancd_date)) == date('Y-m', strtotime($year . '-' . $month))) || ($a->ins_village == $d->ds_destination && $a->sancl_sifilis == 2 && date('Y-m', strtotime($a->sancd_date)) == date('Y-m', strtotime($year . '-' . $month)))) {
            ...
            <tr style=" border: 1px solid black;">
                ...
                <td style=" border: 1px solid black; text-align: center;">
                    <?php
                        ...
                        foreach ($lab as $a) {
                            if (($a->ins_village == $d->ds_destination && $a->sancl_sifilis == 2 && date('Y-m', strtotime($a->sancd_date)) == date('Y-m', strtotime($year . '-' . $month)))) {
            ...
            <tr style=" border: 1px solid black;">
                ...
                <td style=" border: 1px solid black; text-align: center;">
                    <?php
                        ...
                        foreach ($fisik as $a) {
                            if ($a->ins_village == $d->ds_destination && $a->sancpe_weight_now != '' && date('Y-m', strtotime($a->sancd_date)) == date('Y-m', strtotime($year . '-' . $month))) {
            ...
            <tr style=" border: 1px solid black;">
                ...
                <td style=" border: 1px solid black; text-align: center;">
                    <?php
                        ...
                        foreach ($fisik as $a) {
                            if ($a->ins_village == $d->ds_destination && $a->sancpe_height != '' && date('Y-m', strtotime($a->sancd_date)) == date('Y-m', strtotime($year . '-' . $month))) {
            ...
            <tr style=" border: 1px solid black;">
                ...
                <td style=" border: 1px solid black; text-align: center;">
                    <?php
                        ...
                        foreach ($fisik as $a) {
                            if ($a->ins_village == $d->ds_destination && $a->sancpe_blood_pressure != '' && date('Y-m', strtotime($a->sancd_date)) == date('Y-m', strtotime($year . '-' . $month))) {
            ...
            <tr style=" border: 1px solid black;">
                ...
                <td style=" border: 1px solid black; text-align: center;">
                    <?php
                        ...
                        foreach ($fisik as $a) {
                            if ($a->ins_village == $d->ds_destination && $a->sancpe_arm != '' && date('Y-m', strtotime($a->sancd_date)) == date('Y-m', strtotime($year . '-' . $month))) {
            ...
            <tr style=" border: 1px solid black;">
                ...
                <td style=" border: 1px solid black; text-align: center;">
                    <?php
                        ...
                        foreach ($fisik as $a) {
                            if ($a->ins_village == $d->ds_destination && $a->sancpe_arm <= 23.5 && date('Y-m', strtotime($a->sancd_date)) == date('Y-m', strtotime($year . '-' . $month))) {
            ...
            <tr style=" border: 1px solid black;">
                ...
                <td style=" border: 1px solid black; text-align: center;">
                    <?php
                        ...
                        foreach ($fisik as $a) {
                            if ($a->ins_village == $d->ds_destination && $a->sancpe_tfu_cm != '' && date('Y-m', strtotime($a->sancd_date)) == date('Y-m', strtotime($year . '-' . $month)) || $a->ins_village == $d->ds_destination && $a->sancpe_tfu_finger != '' && date('Y-m', strtotime($a->sancd_date)) == date('Y-m', strtotime($year . '-' . $month))) {
            ...
            <tr style=" border: 1px solid black;">
                ...
                <td style=" border: 1px solid black; text-align: center;">
                    <?php
                        ...
                        foreach ($fisik as $a) {
                            if ($a->ins_village == $d->ds_destination && $a->sancpe_djj != '' && date('Y-m', strtotime($a->sancd_date)) == date('Y-m', strtotime($year . '-' . $month))) {
            ...
            <tr style=" border: 1px solid black;">
                ...
                <td style=" border: 1px solid black; text-align: center;">
                    <?php
                        ...
                        foreach ($fisik as $a) {
                            if ($a->ins_village == $d->ds_destination && $a->sanct_tt == 2 && date('Y-m', strtotime($a->sancd_date)) == date('Y-m', strtotime($year . '-' . $month))) {
            ...
            <tr style=" border: 1px solid black;">
                ...
                <td style=" border: 1px solid black; text-align: center;">
                    <?php
                        ...
                        foreach ($fisik as $a) {
                            if ($a->ins_village == $d->ds_destination && $a->sanct_tt == 3 && date('Y-m', strtotime($a->sancd_date)) == date('Y-m', strtotime($year . '-' . $month))) {
            ...
            <tr style=" border: 1px solid black;">
                ...
                <td style=" border: 1px solid black; text-align: center;">
                    <?php
                        ...
                        foreach ($fisik as $a) {
                            if ($a->ins_village == $d->ds_destination && $a->sanct_tt == 4 && date('Y-m', strtotime($a->sancd_date)) == date('Y-m', strtotime($year . '-' . $month))) {
            ...
            <tr style=" border: 1px solid black;">
                ...
                <td style=" border: 1px solid black; text-align: center;">
                    <?php
                        ...
                        foreach ($fisik as $a) {
                            if ($a->ins_village == $d->ds_destination && $a->sanct_tt == 5 && date('Y-m', strtotime($a->sancd_date)) == date('Y-m', strtotime($year . '-' . $month))) {
            ...
            <tr style=" border: 1px solid black;">
                ...
                <td style=" border: 1px solid black; text-align: center;">
                    <?php
                        ...
                        foreach ($fisik as $a) {
                            if ($a->ins_village == $d->ds_destination && $a->sanct_tt == 6 && date('Y-m', strtotime($a->sancd_date)) == date('Y-m', strtotime($year . '-' . $month))) {
            ...
            <tr style=" border: 1px solid black;">
                ...
                <td style=" border: 1px solid black; text-align: center;">
                    <?php
                        ...
                        foreach ($lab as $a) {
                            if ($a->ins_village == $d->ds_destination && $a->sancl_hb == 1 && date('Y-m', strtotime($a->sancd_date)) == date('Y-m', strtotime($year . '-' . $month))) {
            ...
            <tr style=" border: 1px solid black;">
                ...
                <td style=" border: 1px solid black; text-align: center;">
                    <?php
                        ...
                        foreach ($lab as $a) {
                            if ($a->ins_village == $d->ds_destination && $a->sancl_level_hb >= 8 && $a->sancl_level_hb <= 11 && date('Y-m', strtotime($a->sancd_date)) == date('Y-m', strtotime($year . '-' . $month))) {
            ...
            <tr style=" border: 1px solid black;">
                ...
                <td style=" border: 1px solid black; text-align: center;">
                    <?php
                        ...
                        foreach ($lab as $a) {
                            if ($a->ins_village == $d->ds_destination && $a->sancl_level_hb != '' && $a->sancl_level_hb < 8 && date('Y-m', strtotime($a->sancd_date)) == date('Y-m', strtotime($year . '-' . $month))) {
            ...
            <tr style=" border: 1px solid black;">
                ...
                <td style=" border: 1px solid black; text-align: center;">
                    <?php
                        ...
                        foreach ($lab as $a) {
                            if ($a->ins_village == $d->ds_destination && $a->sancl_level_hb != '' && $a->sancl_level_hb < 12 && date('Y-m', strtotime($a->sancd_date)) == date('Y-m', strtotime($year . '-' . $month))) {
            ...
            <tr style=" border: 1px solid black;">
                ...
                <td style=" border: 1px solid black; text-align: center;">
                    <?php
                        ...
                        foreach ($lab as $a) {
                            if ($a->ins_village == $d->ds_destination && $a->sancl_urine != 0 && date('Y-m', strtotime($a->sancd_date)) == date('Y-m', strtotime($year . '-' . $month))) {
            ...
            <tr style=" border: 1px solid black;">
                ...
                <td style=" border: 1px solid black; text-align: center;">
                    <?php
                        ...
                        foreach ($lab as $a) {
                            if ($a->ins_village == $d->ds_destination && $a->sancl_urine > 1 && date('Y-m', strtotime($a->sancd_date)) == date('Y-m', strtotime($year . '-' . $month))) {
            ...
            <tr style=" border: 1px solid black;">
                ...
                <td style=" border: 1px solid black; text-align: center;">
                    <?php
                        ...
                        foreach ($lab as $a) {
                            if ($a->ins_village == $d->ds_destination && $a->sancl_blood_sugar != '' && date('Y-m', strtotime($a->sancd_date)) == date('Y-m', strtotime($year . '-' . $month))) {
            ...
            <tr style=" border: 1px solid black;">
                ...
                <td style=" border: 1px solid black; text-align: center;">
                    <?php
                        ...
                        foreach ($lab as $a) {
                            if ($a->ins_village == $d->ds_destination && $a->sancl_blood_sugar >= 200 && date('Y-m', strtotime($a->sancd_date)) == date('Y-m', strtotime($year . '-' . $month))) {
            ...
            <tr style=" border: 1px solid black;">
                ...
                <td style=" border: 1px solid black; text-align: center;">
                    <?php
                        ...
                        foreach ($kie as $a) {
                            if ($a->ins_village == $d->ds_destination) {
            ...
            <tr style=" border: 1px solid black;">
                ...
                <td style=" border: 1px solid black; text-align: center;">
                    <?php
                        ...
                        foreach ($lab as $a) {
                            if ($a->ins_village == $d->ds_destination && $a->sancl_hiv != 2 && date('Y-m', strtotime($a->sancd_date)) == date('Y-m', strtotime($year . '-' . $month))) {
            ...
            <tr style=" border: 1px solid black;">
                ...
                <td style=" border: 1px solid black; text-align: center;">
                    <?php
                        ...
                        foreach ($lab as $a) {
                            if ($a->ins_village == $d->ds_destination && $a->sancl_hiv == 1 && date('Y-m', strtotime($a->sancd_date)) == date('Y-m', strtotime($year . '-' . $month))) {
            ...
            <tr style=" border: 1px solid black;">
                ...
                <td style=" border: 1px solid black; text-align: center;">
                    <?php
                        ...
                        foreach ($salinhiv as $a) {
                            if ($a->ins_village == $d->ds_destination && $a->sancm_met_marr == 2) {
            ...
            <tr style=" border: 1px solid black;">
                ...
                <td style=" border: 1px solid black; text-align: center;">
                    <?php
                        ...
                        foreach ($salinhiv as $a) {
                            if ($a->ins_village == $d->ds_destination && $a->sancm_met_marr == 2 && $a->sancmskl_sex == 1) {
            ...
            <tr style=" border: 1px solid black;">
                ...
                <td style=" border: 1px solid black; text-align: center;">
                    <?php
                        ...
                        foreach ($salinhiv as $a) {
                            if ($a->ins_village == $d->ds_destination && $a->sancm_met_marr == 2 && $a->sancmskl_sex == 2) {
            ...
            <tr style=" border: 1px solid black;">
                ...
                <td style=" border: 1px solid black; text-align: center;">
                    <?php
                        ...
                        foreach ($salinhiv as $a) {
                            if ($a->ins_village == $d->ds_destination && $a->sancm_met_marr == 3) {
            ...
            <tr style=" border: 1px solid black;">
                ...
                <td style=" border: 1px solid black; text-align: center;">
                    <?php
                        ...
                        foreach ($salinhiv as $a) {
                            if ($a->ins_village == $d->ds_destination && $a->sancm_met_marr == 3 && $a->sancmskl_sex == 2) {
            ...
            <tr style=" border: 1px solid black;">
                ...
                <td style=" border: 1px solid black; text-align: center;">
                    <?php
                        ...
                        foreach ($lab as $a) {
                            if ($a->ins_village == $d->ds_destination && $a->sancl_sifilis != 0) {
            ...
            <tr style=" border: 1px solid black;">
                ...
                <td style=" border: 1px solid black; text-align: center;">
                    <?php
                        ...
                        foreach ($lab as $a) {
                            if ($a->ins_village == $d->ds_destination && $a->sancl_sifilis == 2) {
            ...
            <tr style=" border: 1px solid black;">
                ...
                <td style=" border: 1px solid black; text-align: center;">
                    <?php
                        ...
                        foreach ($lab as $a) {
                            if ($a->ins_village == $d->ds_destination && $a->sancl_hbsag != 0) {
                                ${'hb' . $d->ds_destination}[] = array(
                                    'set' => $a->sancl_urine
                                );
                            }
            ...
            <tr style=" border: 1px solid black;">
                ...
                <td style=" border: 1px solid black; text-align: center;">
                    <?php
                        ...
                        foreach ($lab as $a) {
                            if ($a->ins_village == $d->ds_destination && $a->sancl_hbsag == 2) {
            ...
            <tr style=" border: 1px solid black;">
                ...
                <td style=" border: 1px solid black; text-align: center;">
                    <?php
                        ...
                        foreach ($salin2 as $a) {
                            if ($a->ins_village == $d->ds_destination && $a->sancd_type == 1 && $a->sancd_no == 1) {
            ...
            <tr style=" border: 1px solid black;">
                ...
                <td style=" border: 1px solid black; text-align: center;">
                    <?php
                        ...
                        foreach ($salin2 as $a) {
                            if ($a->ins_village == $d->ds_destination && $a->sancd_type == 1 && $a->sancd_no == 1 && (date('Y', strtotime(DB::table('eianc_patients')->where('pat_norm', $a->sanc_norm)->value('pat_dob'))) - date('Y', strtotime($a->sancd_date))) < 18) {
            ...
            <tr style=" border: 1px solid black;">
                ...
                <td style=" border: 1px solid black; text-align: center;">
                    <?php
                        ...
                        foreach ($salin2 as $a) {
                            if ($a->ins_village == $d->ds_destination && $a->sancd_type == 1 && $a->sancd_no == 1 && (date('Y', strtotime(DB::table('eianc_patients')->where('pat_norm', $a->sanc_norm)->value('pat_dob'))) - date('Y', strtotime($a->sancd_date))) >= 18 && (date('Y', strtotime(DB::table('eianc_patients')->where('pat_norm', $a->sanc_norm)->value('pat_dob'))) - date('Y', strtotime($a->sancd_date))) <= 20) {
            ...
            <tr style=" border: 1px solid black;">
                ...
                <td style=" border: 1px solid black; text-align: center;">
                    <?php
                        ...
                        foreach ($salin2 as $a) {
                            if ($a->ins_village == $d->ds_destination && $a->sancd_type == 1 && $a->sancd_no == 1 && (date('Y', strtotime(DB::table('eianc_patients')->where('pat_norm', $a->sanc_norm)->value('pat_dob'))) - date('Y', strtotime($a->sancd_date))) >= 21 && (date('Y', strtotime(DB::table('eianc_patients')->where('pat_norm', $a->sanc_norm)->value('pat_dob'))) - date('Y', strtotime($a->sancd_date))) <= 35) {
            ...
            <tr style=" border: 1px solid black;">
                ...
                <td style=" border: 1px solid black; text-align: center;">
                    <?php
                        ...
                        foreach ($salin2 as $a) {
                            if ($a->ins_village == $d->ds_destination && $a->sancd_type == 1 && $a->sancd_no == 1 && (date('Y', strtotime(DB::table('eianc_patients')->where('pat_norm', $a->sanc_norm)->value('pat_dob'))) - date('Y', strtotime($a->sancd_date))) > 35) {
            ...
            <tr style=" border: 1px solid black;">
                ...
                <td style=" border: 1px solid black; text-align: center;">
                    <?php
                        ...
                        foreach ($salin as $a) {
                            if ($a->ins_village == $d->ds_destination && $a->sancmskl_cond == 1) {
            ...
            <tr style=" border: 1px solid black;">
                ...
                <td style=" border: 1px solid black; text-align: center;">
                    <?php
                        ...
                        foreach ($salin as $a) {
                            if ($a->ins_village == $d->ds_destination && $a->sancmskl_cond == 1 && $a->sancmskl_sex == 2) {
            ...
            <tr style=" border: 1px solid black;">
                ...
                <td style=" border: 1px solid black; text-align: center;">
                    <?php
                        ...
                        foreach ($salin as $a) {
                            if ($a->ins_village == $d->ds_destination && $a->sancmskl_cond == 0) {
            ...
            <tr style=" border: 1px solid black;">
                ...
                <td style=" border: 1px solid black; text-align: center;">
                    <?php
                        ...
                        foreach ($salin as $a) {
                            if ($a->ins_village == $d->ds_destination && $a->sancmskl_cond == 0 && $a->sancmskl_sex == 1) {
            ...
            <tr style=" border: 1px solid black;">
                ...
                <td style=" border: 1px solid black; text-align: center;">
                    <?php
                        ...
                        foreach ($salin as $a) {
                            if ($a->ins_village == $d->ds_destination && $a->sancmskl_cond == 0 && $a->sancmskl_sex == 2) {
            ...
            <tr style=" border: 1px solid black;">
                ...
                <td style=" border: 1px solid black; text-align: center;">
                    <?php
                        ...
                        foreach ($salin as $a) {
                            if ($a->ins_village == $d->ds_destination && (date('Y-m-d', strtotime($a->sancmskl_date)) < date('Y-m-d', strtotime($a->sanc_hpl . '-7 days')))) {
            ...
            <tr style=" border: 1px solid black;">
                ...
                <td style=" border: 1px solid black; text-align: center;">
                    <?php
                        ...
                        foreach ($salin as $a) {
                            if ($a->ins_village == $d->ds_destination && $a->sancmskl_sex == 1 && (date('Y-m-d', strtotime($a->sancmskl_date)) < date('Y-m-d', strtotime($a->sanc_hpl . '-7 days')))) {
            ...
            <tr style=" border: 1px solid black;">
                ...
                <td style=" border: 1px solid black; text-align: center;">
                    <?php
                        ...
                        foreach ($salin as $a) {
                            if ($a->ins_village == $d->ds_destination && $a->sancmskl_sex == 2 && (date('Y-m-d', strtotime($a->sancmskl_date)) < date('Y-m-d', strtotime($a->sanc_hpl . '-7 days')))) {
            ...
            <tr style=" border: 1px solid black;">
                ...
                <td style=" border: 1px solid black; text-align: center;">
                    <?php
                        ...
                        foreach ($salin as $a) {
                            if ($a->ins_village == $d->ds_destination && $a->sancmskl_weight < 2500) {
            ...
            <tr style=" border: 1px solid black;">
                ...
                <td style=" border: 1px solid black; text-align: center;">
                    <?php
                        ...
                        foreach ($salin as $a) {
                            if ($a->ins_village == $d->ds_destination && $a->sancmskl_weight < 2500 && $a->sancmskl_sex == 1) {
            ...
            <tr style=" border: 1px solid black;">
                ...
                <td style=" border: 1px solid black; text-align: center;">
                    <?php
                        ...
                        foreach ($salin as $a) {
                            if ($a->ins_village == $d->ds_destination && $a->sancmskl_weight < 2500 && $a->sancmskl_sex == 2) {
            ...
            <tr style=" border: 1px solid black;">
                ...
                <td style=" border: 1px solid black; text-align: center;">
                    <?php
                        ...
                        foreach ($salin as $a) {
                            if ($a->ins_village == $d->ds_destination && $a->sancmskl_cond_baby == 1) {
            ...
            <tr style=" border: 1px solid black;">
                ...
                <td style=" border: 1px solid black; text-align: center;">
                    <?php
                        ...
                        foreach ($salin as $a) {
                            if ($a->ins_village == $d->ds_destination && $a->sancmskl_cond_baby == 1 && $a->sancmskl_sex == 1) {
            ...
            <tr style=" border: 1px solid black;">
                ...
                <td style=" border: 1px solid black; text-align: center;">
                    <?php
                        ...
                        foreach ($salin as $a) {
                            if ($a->ins_village == $d->ds_destination && $a->sancmskl_cond_baby == 1 && $a->sancmskl_sex == 2) {
            ...
            <tr style=" border: 1px solid black;">
                ...
                <td style=" border: 1px solid black; text-align: center;">
                    <?php
                        ...
                        foreach ($salin as $a) {
                            if ($a->ins_village == $d->ds_destination && $a->sancmskl_cond_baby == 0) {
            ...
            <tr style=" border: 1px solid black;">
                ...
                <td style=" border: 1px solid black; text-align: center;">
                    <?php
                        ...
                        foreach ($salin as $a) {
                            if ($a->ins_village == $d->ds_destination && $a->sancmskl_cond_baby == 0 && $a->sancmskl_sex == 1) {
            ...
            <tr style=" border: 1px solid black;">
                ...
                <td style=" border: 1px solid black; text-align: center;">
                    <?php
                        ...
                        foreach ($salin as $a) {
                            if ($a->ins_village == $d->ds_destination && $a->sancmskl_cond_baby == 0 && $a->sancmskl_sex == 2) {
            ...
            <tr style=" border: 1px solid black;">
                ...
                <td style=" border: 1px solid black; text-align: center;">
                    <?php
                        ...
                        foreach ($neo28 as $a) {
                            if ($a->ins_village == $d->ds_destination && (date('Y-m-d', strtotime($a->neo28_date)) < date('Y-m-d', strtotime($a->pat_dob . '+4 days'))) ) {
            ...
            <tr style=" border: 1px solid black;">
                ...
                <td style=" border: 1px solid black; text-align: center;">
                    <?php
                        ...
                        foreach ($neo28 as $a) {
                            if ($a->ins_village == $d->ds_destination && $a->pat_sex == 1 && (date('Y-m-d', strtotime($a->neo28_date)) < date('Y-m-d', strtotime($a->pat_dob . '+4 days')))) {
            ...
            <tr style=" border: 1px solid black;">
                ...
                <td style=" border: 1px solid black; text-align: center;">
                    <?php
                        ...
                        foreach ($neo28 as $a) {
                            if ($a->ins_village == $d->ds_destination && $a->pat_sex == 2 && (date('Y-m-d', strtotime($a->neo28_date)) < date('Y-m-d', strtotime($a->pat_dob . '+4 days')))) {
            ...
            <tr style=" border: 1px solid black;">
                ...
                <td style=" border: 1px solid black; text-align: center;">
                    <?php
                        ...
                        foreach ($neo28 as $a) {
                            if ($a->ins_village == $d->ds_destination && (date('Y-m-d', strtotime($a->neo28_date)) >= date('Y-m-d', strtotime($a->pat_dob . '+4 days'))) && (date('Y-m-d', strtotime($a->neo28_date)) <= date('Y-m-d', strtotime($a->pat_dob . '+7 days'))) ) {
            ...
            <tr style=" border: 1px solid black;">
                ...
                <td style=" border: 1px solid black; text-align: center;">
                    <?php
                        ...
                        foreach ($neo28 as $a) {
                            if ($a->ins_village == $d->ds_destination && $a->pat_sex == 1 && (date('Y-m-d', strtotime($a->neo28_date)) >= date('Y-m-d', strtotime($a->pat_dob . '+4 days'))) && (date('Y-m-d', strtotime($a->neo28_date)) <= date('Y-m-d', strtotime($a->pat_dob . '+7 days'))) ) {
            ...
            <tr style=" border: 1px solid black;">
                ...
                <td style=" border: 1px solid black; text-align: center;">
                    <?php
                        ...
                        foreach ($neo28 as $a) {
                            if ($a->ins_village == $d->ds_destination && $a->pat_sex == 2 && (date('Y-m-d', strtotime($a->neo28_date)) >= date('Y-m-d', strtotime($a->pat_dob . '+4 days'))) && (date('Y-m-d', strtotime($a->neo28_date)) <= date('Y-m-d', strtotime($a->pat_dob . '+7 days'))) ) {
            ...
            <tr style=" border: 1px solid black;">
                ...
                <td style=" border: 1px solid black; text-align: center;">
                    <?php
                        ...
                        foreach ($neo28 as $a) {
                            if ($a->ins_village == $d->ds_destination && (date('Y-m-d', strtotime($a->neo28_date)) >= date('Y-m-d', strtotime($a->pat_dob . '+8 days'))) && (date('Y-m-d', strtotime($a->neo28_date)) <= date('Y-m-d', strtotime($a->pat_dob . '+28 days'))) ) {
            ...
            <tr style=" border: 1px solid black;">
                ...
                <td style=" border: 1px solid black; text-align: center;">
                    <?php
                        ...
                        foreach ($neo28 as $a) {
                            if ($a->ins_village == $d->ds_destination && $a->pat_sex == 1 && (date('Y-m-d', strtotime($a->neo28_date)) >= date('Y-m-d', strtotime($a->pat_dob . '+8 days'))) && (date('Y-m-d', strtotime($a->neo28_date)) <= date('Y-m-d', strtotime($a->pat_dob . '+28 days'))) ) {
            ...
            <tr style=" border: 1px solid black;">
                ...
                <td style=" border: 1px solid black; text-align: center;">
                    <?php
                        ...
                        foreach ($neo28 as $a) {
                            if ($a->ins_village == $d->ds_destination && $a->pat_sex == 2 && (date('Y-m-d', strtotime($a->neo28_date)) >= date('Y-m-d', strtotime($a->pat_dob . '+8 days'))) && (date('Y-m-d', strtotime($a->neo28_date)) <= date('Y-m-d', strtotime($a->pat_dob . '+28 days'))) ) {
            ...
            <tr style=" border: 1px solid black;">
                ...
                <td style=" border: 1px solid black; text-align: center;">
                    <?php
                        ...
                        foreach ($salin as $a) {
                            if ($a->ins_village == $d->ds_destination && $a->sancmskl_sex == 1) {
            ...
            <tr style=" border: 1px solid black;">
                ...
                <td style=" border: 1px solid black; text-align: center;">
                    <?php
                        ...
                        foreach ($salin as $a) {
                            if ($a->ins_village == $d->ds_destination && $a->sancmskl_sex == 2) {
                ...
                <tr style=" border: 1px solid black;">
                    ...
                    <td style=" border: 1px solid black; text-align: center;">
                        <?php
                            ...
                            foreach ($nifas as $a) {
                                if ($a->ins_village == $d->ds_destination && $a->sancd_type == 2 && $a->sancd_no == 1) {
                ...
                <tr style=" border: 1px solid black;">
                    ...
                    <td style=" border: 1px solid black; text-align: center;">
                        <?php
                            ...
                            foreach ($nifas as $a) {
                                if ($a->ins_village == $d->ds_destination && $a->sancd_type == 2 && $a->sancd_no == 2) {
                                    ${'nifask1' . $d->ds_destination}[] = array(
                                        'set' => 1
                                    );
                                }
                ...
                <tr style=" border: 1px solid black;">
                    ...
                    <td style=" border: 1px solid black; text-align: center;">
                        <?php
                            ...
                            foreach ($nifas as $a) {
                                if ($a->ins_village == $d->ds_destination && $a->sancd_type == 2 && $a->sancd_no == 3) {
                                    ${'nifask1' . $d->ds_destination}[] = array(
                                        'set' => 1
                                    );
                                }
                    ...
                    <td style=" border: 1px solid black; text-align: center;">
                        <?php
                            ...
                            foreach ($nifas as $a) {
                                if ($a->sancd_type == 2 && $a->sancd_no == 3) {
                                    $nifask1total[] = array(
                                        'set' => 1
                                    );
                                }
    ...
    <table width="100%" style="font-size: 10pt; margin-top: 10pt;">
        <tr>
            <td style="text-align: center">
                ...
                Mengetahui
                <br>
                Kepala Puskesmas Kecamatan {{ strtoupper($al_subdis) }}
                <br>
                <br>
                <br>
                <br>
            ...
            <td style="text-align: center">
                ...
                {{ $al_dis . ', ' . date('d-m-Y') }}
                <br>
                Pengelola KIA Kecamatan {{ strtoupper($al_subdis) }}
                <br>
                <br>
                <br>
                <br>
