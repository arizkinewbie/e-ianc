...
<body>
    ...
    <table style="width: 100%; border-collapse: collapse; font-size: 8pt;">
        <thead style=" border: 1px solid black;">
            ...
            <tr style=" border: 1px solid black;">
                ...
                <th style=" border: 1px solid black;">Status Gizi(K/N)</th>
        ...
        <tbody style=" border: 1px solid black;">
            ...
            @endforeach
            <tr style=" border: 1px solid black;">
                <td style=" border: 1px solid rgb(216, 208, 208); text-align : center; background-color : black; color : white;" colspan="22">PERSALINAN</td>
            </tr>
            @foreach ($salin as $d)
                <tr style=" border: 1px solid black;">
                    <td style=" border: 1px solid black; text-align : center;">{{ $loop->iteration }}</td>
    ...
    <table style="width: 100%; border-collapse: collapse; font-size: 8pt;">
        ...
        <tbody style=" border: 1px solid black;">
            ...
            @endforeach
            <tr style=" border: 1px solid black;">
                <td style=" border: 1px solid rgb(216, 208, 208); text-align : center; background-color : black; color : white;" colspan="25">PERSALINAN</td>
            </tr>
            @foreach ($salin as $d)
                <tr style=" border: 1px solid black;">
                    <td style=" border: 1px solid black; text-align : center;">{{ $loop->iteration }}</td>
